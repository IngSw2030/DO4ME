...
$symbol_position=$settings->get_option('d4mcurrency_symbol_position');
$decimal=$settings->get_option('d4mprice_format_decimal_places'); 
$currency_symbol =$settings->get_option('d4mcurrency_symbol');
...
$staff_id = $_SESSION['d4mstaffid'];
?>
<div class="cta-panel-default" id="d4m-staff-dashboard">
	<div class="staff-dashboard d4m-left-menu col-md-12 col-sm-12 col-xs-12 col-lg-12 navbar-collapse collapse" id="navbarCollapseMain">
							...
							<table id="staff-bookings-table" class="display responsive nowrap table table-striped table-bordered" cellspacing="0" width="100%">
								...
								if(sizeof((array)$staff_service_details) > 0){
									foreach($staff_service_details as $arr_staff){
										...
										$status_insert_id = $bookings->staff_status_seled4mstaff_id();
									...
									<tr>
											...
											?>
											<a name="" class="btn btn-success d4m-btn-width" disabled <?php echo $label_language_values['accepted'];?>><?php echo $label_language_values['accepted'];?></a>
											<?php }else{	 ?>
											<a id="accept_appointment" data-id="<?php echo $arr_staff['order_id'];?>" data-idd="<?php echo $status_insert_id;?>" data-status='A'  value="" name="" class="btn btn-info d4m-btn-width" type="submit" title="<?php echo $label_language_values['accept'];?>"><?php echo $label_language_values['accept'];?></a>
											<a id="decline_appointment" data-id="<?php echo $arr_staff['order_id'];?>" data-idd="<?php echo $status_insert_id;?>" data-status='D'  value="" name="" class="btn btn-danger d4m-btn-width" type="submit" <?php echo $label_language_values['decline'];?>><?php echo $label_language_values['decline'];?></a>
											<?php   }
											}
											?>
											</td>
											<td>
												...
												?>
												<a name="" class="btn btn-success d4m-btn-width" disabled <?php echo $label_language_values['completed'];?>><?php echo $label_language_values['completed'];?></a>
												<?php
												} elseif($today_date >= $book_date && $rec_status_details=='A' && $status_insert_id != ""){
												?>
												<a id="payment_status" data-toggle="popover"  class="btn btn-info d4m-btn-width" rel="popover" data-placement='left'><?php echo $label_language_values['paid'];?></a>
													...
													<table class="form-horizontal" cellspacing="0">
														...
														<tr>
															<td>
																...
																<button id="d4m-close-popover-delete-service" class="btn btn-default btn-sm" href="javascript:void(0)"><?php echo $label_language_values['cancel'];?></button>
															</td>                      
														</tr>
														</tbody>
													</table>
          ...
          <div class="panel-body">
							...
							<div class="container-fluid tab-content d4m-staff-right-details">
								<div class="tab-pane col-lg-12 col-md-12 col-sm-12 col-xs-12 active" id="member-details">
									<div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
										<table class="d4m-staff-common-table">
											<tbody>
											<tr>
											...
											<tr>
												<td><span class="login_user_id" id="login_user_id" data-id="<?php echo $_SESSION['d4mstaffid']; ?>"></td>
											</tr>
											</tbody>
										</table>
									</div>
																	...
																	for ($j = 1; $j <= 7; $j++) {
																		...
																		<span class="col-sm-2 col-md-2 col-lg-2 col-xs-12">
																			<label class="cta-col2" for="d4m-monFirst<?php  echo $i; ?><?php echo $j; ?>_<?php  echo $getvalue[0]; ?>">
																				<input class='chkdaynew' data-toggle="toggle" data-size="small" type='checkbox' id="d4m-monFirst<?php  echo $i; ?><?php echo $j; ?>_<?php  echo $getvalue[0]; ?>" <?php  if ($getvalue[6] == 'Y' || $getvalue[6] == '') { echo ""; } else { echo "checked"; } ?> data-on="<?php echo $label_language_values['o_n'];?>" data-off="<?php echo $label_language_values['off'];?>" data-onstyle='primary' data-offstyle='default' />
																			</label>
																		</span>
																		<span class="col-sm-7 col-md-7 col-lg-7 col-xs-12 d4m-staff-time-schedule">
											...
											<tr>
												...
												<td>
													<a id="" value="" name="update_schedule"
														 class="btn btn-success d4m-btn-width btnupdatenewtimeslots_monthly"
																		...
																		for ($j = 1; $j <= 7; $j++) {
																			...
																			<li class="active">
																				...
																				<?php 
																					...
																					<span class="col-sm-2 col-md-2 col-lg-2 col-xs-12">
																					<a id="d4m-add-staff-breaks" data-staff_id="<?php echo $_SESSION['d4mstaffid']; ?>" data-weekid="<?php echo $i;?>" data-weekday="<?php echo $j;?>" class="btn btn-small btn-success d4m-small-br-btn myct-add-staff-breaks" data-id="<?php echo $i;?>_<?php  echo $j;?>"><?php echo $label_language_values['add_break'];?></a>
																					</span>
																				<?php    } ?>
																				<span class="col-sm-7 col-md-7 col-lg-7 col-xs-12 d4m-staff-breaks-schedule">
																				<ul class="list-unstyled" id="d4m-add-break-ul<?php  echo $i;?>_<?php  echo $j;?>">
																					...
																					while($rrr = mysqli_fetch_array($jc)){
																						...
																						<li>
																							...
																							<button id="d4m-delete-staff-break<?php  echo $rrr['id'];?>_<?php  echo $i;?>_<?php  echo $j;?>" data-wiwdibi='<?php echo $rrr['id'];?>_<?php  echo $i;?>_<?php  echo $j;?>' data-break_id="<?php echo $rrr['id'];?>" class="pull-right btn btn-circle btn-default delete_break" rel="popover" data-placement='left' title="<?php echo $label_language_values['are_you_sure'];?>?"> <i class="fa fa-trash"></i></button>
								...
								<div class="tab-pane member-offtime" id="member-offtime">
									<div class="panel panel-default">
										<div class="panel-body">
											...
											<div class="d4m-staff-member-offtime-list-main mytablefor_offtimes cb col-md-12 col-xs-12 mt-20">
											...
											str_replace($english_date_array,$selected_lang_label,date($getdateformat,strtotime($edates))); ?></td>
																...
																?>
																<td><a data-id="<?php echo $r['id'];?>" class='btn btn-danger d4mdelete_provider left-margin'><span
								...
								<div class="tab-pane member-offdays mt-10" id="member-offdays">
									<div class="panel panel-default">
										<?php 
										$offday->user_id=$_SESSION['d4mstaffid'];
												...
												<div class="pull-left">
													<div class="d4m-custom-checkbox">
														<ul class="d4m-checkbox-list">
															<li>
																<input style="margin:0px;" type="checkbox"  class="fullmonthoff all" data-prov_id="<?php echo $_SESSION['d4mstaffid']; ?>" id="<?php echo $year.'-'.$this_month;?>" <?php   $offday->off_year_month=$year.'-'.$this_month;
											...
											while ($i<=$insgesamt) {
												...
												if (($i==$date) && ($this_month==$month_num)) {
													if(isset($arr_all_off_day)  && in_array($cal_cur_date, $arr_all_off_day)) {
														echo '<td  id="'.$year.'-'.$this_month.'-'.$i.'" data-prov_id="'.$_SESSION['d4mstaffid'].'" class="selectedDate RR offsingledate"  align=center >';
													} else {
														echo '<td  id="'.$year.'-'.$this_month.'-'.$i.'" data-prov_id="'.$_SESSION['d4mstaffid'].'"  class="date_single RR offsingledate"  align=center>';
													}
												} else {
													if(isset($arr_all_off_day)  &&  in_array($cal_cur_date, $arr_all_off_day)) {
														echo '<td  id="'.$year.'-'.$this_month.'-'.$i.'"  data-prov_id="'.$_SESSION['d4mstaffid'].'"  class="selectedDate RR offsingledate highlight"  align=center>';
													} else {
														echo '<td  id="'.$year.'-'.$this_month.'-'.$i.'" data-prov_id="'.$_SESSION['d4mstaffid'].'" class="date_single RR offsingledate"  align=center>';
													}
												}
			...
			<div class="tab-pane fade" id="my-wallet">
				<div class="panel panel-default">
					<div class="panel-heading">
            <?php
              $objadmin->id = $_SESSION['d4mstaffid'];
					...
					<div class="panel-body mt-30">
						<div class="table-responsive get_payment_staff_by_date_append">
							<table id="staff-payments-details" class="display responsive nowrap table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
									<?php  
									$readall_d4mstaff_commision = $staff_commision->get_booking_assign($staff_id);
									
									if(mysqli_num_rows($readall_d4mstaff_commision) >0){
										$i=1;
										while($row = mysqli_fetch_array($readall_d4mstaff_commision)){
											?>
											<tr>
												<td><?php echo $i; ?></td>
						...
						<div class="container-fluid npl npr">
							<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
								<div class="d4m-clean-service-image-uploader">
									...
									?>
									<img data-imagename="" id="pppp<?php  echo $staff_id; ?>staffimage" src="<?php echo $imagepath;?>" class="d4m-clean-staff-image br-100" height="100" width="100">
									<input data-us="pppp<?php  echo $staff_id; ?>" class="hide d4m-upload-images" type="file" name="" id="d4m-upload-imagepppp<?php  echo $staff_id;?>" data-id="<?php echo $staff_id;?>" />
									<?php 
									if($staff_read['image']==''){
										?>
										<label for="d4m-upload-imagepppp<?php  echo $staff_id; ?>" class="d4m-clean-staff-img-icon-label old_cam_ser<?php  echo $staff_id; ?>">
											<i class="d4m-camera-icon-common br-100 fa fa-camera" id="pcls<?php  echo $staff_id; ?>camera"></i>
											<i class="pull-left fa fa-plus-circle fa-2x" id="ctsc<?php  echo $staff_id; ?>plus"></i>
										</label>
									<?php    
									}
									?>
									<label for="d4m-upload-imagepppp<?php  echo $staff_id; ?>" class="d4m-clean-staff-img-icon-label new_cam_ser ser_cam_btn<?php  echo $staff_id; ?>" id="d4m-upload-imagepppp<?php  echo $staff_id; ?>" style="display:none;">
										<i class="d4m-camera-icon-common br-100 fa fa-camera stfp-cam-icon" id="pppp<?php  echo $staff_id; ?>camera"></i>
										<i class="pull-left fa fa-plus-circle fa-2x stfp-add-icon" id="ctsc<?php  echo $staff_id; ?>plus"></i>
									</label>
									<?php 
									if( $staff_read['image'] !==''){
										?>
										<a id="d4m-remove-staff-imagepppp<?php  echo $staff_id; ?>" data-pclsid="<?php echo $staff_id; ?>" data-staff_id="<?php echo $staff_id; ?>" class="delete_staff_image pull-left br-100 btn-danger bt-remove-staff-img btn-xs ser_new_del<?php  echo $staff_id; ?>" rel="popover" data-placement='left' title="<?php echo $label_language_values['remove_image'];?>"> <i class="fa fa-trash" title="<?php echo $label_language_values['remove_service_image'];?>"></i></a>
									<?php 
									}
									?>
									 <label><b class="error-service error_image" style="color:red;"></b></label>
									<div id="popover-d4m-remove-staff-imagepppp<?php  echo $staff_id; ?>" style="display: none;">
										<div class="arrow"></div>
										<table class="form-horizontal" cellspacing="0">
											<tbody>
											<tr>
								...
								<div id="d4m-image-upload-popuppppp<?php  echo $staff_id; ?>" class="d4m-image-upload-popup modal fade" tabindex="-1" role="dialog">
									<div class="vertical-alignment-helper">
										<div class="modal-dialog modal-md vertical-align-center">
											<div class="modal-content">
												<div class="modal-header">
													<div class="col-md-12 col-xs-12">
														<a data-staff_id="<?php echo $staff_id; ?>" data-us="pppp<?php  echo $staff_id; ?>" class="btn btn-success d4mupload_img_staff" data-imageinputid="d4m-upload-imagepppp<?php  echo $staff_id; ?>" data-id="<?php echo $staff_id; ?>"><?php echo $label_language_values['crop_and_save'];?></a>
												...
												<div class="modal-body">
													<img id="d4m-preview-imgpppp<?php  echo $staff_id; ?>" style="width: 100%;"  />
												</div>
												<div class="modal-footer">
							...
							<div class="col-lg-10 col-md-10 col-sm-10 col-xs-12 mt-10">
								<div class="d4m-staff-common-table">
									<form id="staff_update_details">
										<div class="form-group col-xs-12 col-md-12">
											...
											<div class="col-xs-8 col-md-10"><input type="text" class="form-control" id="d4m-member-name" value="<?php echo $staff_read[3]; ?>" name="u_member_name" /></div>
										</div>
										<div class="form-group col-xs-12 col-md-12">
											<div class="col-xs-4 col-md-2"><label for="d4m-member-name"><?php echo $label_language_values['email'];?></label></div>
											<div class="col-xs-8 col-md-10"><input type="text" class="form-control" id="d4m-member-email" readonly value="<?php echo $staff_read[2]; ?>" name="" /></div>
										</div>
										<div class="form-group col-xs-12 col-md-12">
											<div class="col-xs-4 col-md-2"><label for="d4m-member-desc"><?php echo $label_language_values['description'];?></label></div>
											<div class="col-xs-8 col-md-10"><textarea class="form-control" id="d4m-member-desc" name="d4m-member-desc" ><?php echo $staff_read[11]; ?></textarea></div>
										</div>
										<div class="form-group col-xs-12 col-md-12">
										...
										<div class="form-group col-xs-12 col-md-12">
											...
											<div class="col-xs-8 col-md-10">
													<input type="text" class="form-control" name="d4m-member-address" id="d4m-member-address" placeholder="Member Street Address" value="<?php echo $staff_read[5]; ?>" />
											</div>
										</div>
										<div class="col-xs-12">	
											<div class="col-xs-12 col-md-6 form-group npl npr">
												...
												<div class="col-xs-8">
													<input class="form-control value_city" id="d4m-member-city" name="d4m-member-city" value="<?php echo $staff_read[6]; ?>" type="text">
												</div>
											</div>
											<div class="col-xs-12 col-md-6 form-group npl npr">
												<div class="col-xs-4"><label for="state"><?php echo $label_language_values['state'];?></label></div>
												<div class="col-xs-8">
													<input class="form-control value_state" id="d4m-member-state" name="d4m-member-state" type="text" value="<?php echo $staff_read[7]; ?>">
												</div>
											</div>
										</div>
										<div class="col-xs-12">
											<div class="col-xs-12 col-md-6 form-group npl npr">
												...
												<div class="col-xs-8">
													<input class="form-control value_zip" id="d4m-member-zip" name="d4m-member-zip" type="text" value="<?php echo $staff_read[8]; ?>">
												</div>
											</div>
											<div class="col-xs-12 col-md-6 form-group npl npr">
												<div class="col-xs-4"><label for="country"><?php echo $label_language_values['country'];?></label></div>
												<div class="col-xs-8">
													<input class="form-control value_country" id="d4m-member-country" name="d4m-member-countrys" type="text" value="<?php echo $staff_read[9]; ?>">
												</div>
											</div>
										</div>
										<div class="col-xs-12">
                      ...
                      <div class="col-xs-8">
                        <input type="checkbox" id="APItestmode" data-toggle="toggle" data-size="small" data-on="<?php echo $label_language_values['yes']; ?>" <?php  if($staff_read[22] == "Y"){ echo "checked";}?> data-off="<?php echo $label_language_values['no']; ?>" data-onstyle="success" data-offstyle="danger" />
										...
										<div class="col-xs-12 mt-12">
											...
											</div>											<div class="col-xs-12 col-md-4 res-text-end">												<a href="javascript:void(0)" id="update_staff_details_staffsection" data-old_schedule_type="" class="btn btn-success d4m-btn-width" data-id="<?php echo $staff_read[0]; ?>"><?php echo $label_language_values['save'];?></a>											</div>
										</div>
										<div class="col-xs-12 mb-20 pt-12">
											<div class="col-md-2 hidden-xs">													<label for="enable-booking1">Change Password</label>												</div>
											<!-- <div class="col-xs-6 col-md-4">
												<a href="javascript:void(0)" id="update_staff_details_staffsection" data-old_schedule_type="" class="btn btn-success d4m-btn-width" data-id="<?php echo $staff_read[0]; ?>"><?php echo $label_language_values['save'];?></a>
											</div> -->
											<div class="col-xs-6 col-md-6">
												<a href="javascript:void(0)" id="change_password_link" class="btn btn-default d4m-btn-width"><?php echo $label_language_values['change_password'];?></a>
											</div>
										</div>
									</form>
									<div id="staff_password_update">
										<form id="staff_password_update_form" novalidate="novalidate">
											...
											<div class="col-xs-12 mb-20">
												...
												<div class="col-xs-8 col-md-10">
													<a id="update_staff_password" class="btn btn-success d4m-btn-width" data-id="<?php echo $staff_read[0]; ?>"><?php echo $label_language_values['update'];?></a>
												</div>
											</div>
										</form>
									</div>
...
if($gc_hook->gc_purchase_status() == 'exist'){
	echo $gc_hook->gc_staff_setting_disconned4mjs_hook();
}
if($gc_hook->gc_purchase_status() == 'exist'){
