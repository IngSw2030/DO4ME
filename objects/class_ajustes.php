...
class do4me_setting{
	...
	public $ct_special_offer_text;
	public $ct_special_offer;
	public $ct_wallet_section;
	...
	public function set_staff_option($option_name, $option_value, $staff_id){
		$query = "select * from `ct_staff_gc` where `staff_id`='".$staff_id."'";
		$result = mysqli_query($this->conn, $query);
		...
		if($ress>0){
			...
			$query = "insert into `ct_staff_gc` (`".$option_name."`, `staff_id`) VALUES ('".$option_value."', '".$staff_id."')";
			$result = mysqli_query($this->conn, $query);
			return $result;
		}
	}
	...
	public function update_languages($language_front_arr,$language_admin_arr,$language_error_arr,$language_extra_arr,$language_form_error_arr,$all){
		$update_default_lang = "UPDATE `ct_languages` set `label_data` = '".$language_front_arr."', `admin_labels` = '".$language_admin_arr."', `error_labels` = '".$language_error_arr."', `extra_labels` = '".$language_extra_arr."', `front_error_labels` = '".$language_form_error_arr."' where `language` = '".$all."'";
