...
class Charge extends ApiResource
{
    ...
    const DECLINED_INCORREd4mNUMBER                  = 'incorred4mnumber';
    const DECLINED_INCORREd4mCVC                     = 'incorred4mcvc';
    const DECLINED_INCORREd4mPIN                     = 'incorred4mpin';
    const DECLINED_INCORREd4mZIP                     = 'incorred4mzip';
