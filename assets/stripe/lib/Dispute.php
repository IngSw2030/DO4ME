...
class Dispute extends ApiResource
{
    ...
    const REASON_INCORREd4mACCOUNT_DETAILS = 'incorred4maccount_details';
    const REASON_INSUFFICIENT_FUNDS        = 'insufficient_funds';
    const REASON_PRODUd4mNOT_RECEIVED      = 'produd4mnot_received';
    const REASON_PRODUd4mUNACCEPTABLE      = 'produd4munacceptable';
