...
$con = new do4me_db();
$conn = $con->connect();
$objservice_addon = new do4me_services_addon();
$objservice_addon_rate = new do4me_services_addon_rates();
...
if (isset($_POST['getservice_addons']))
{
    ...
    {
        $i++; ?>             
<li class="panel panel-default d4m-clean-services-panel cta-addon-icons mysortlistaddons" id="addons_service_<?php echo $arrs['id']; ?>" data-id="<?php echo $arrs['id']; ?>" data-position="<?php echo $arrs['position']; ?>">
   <div class="panel-heading">
      <h4 class="panel-title">
         <div class="cta-col7">
            ...
            <span class="d4m-clean-service-title-name" id="addons_service_name<?php echo $arrs['id']; ?>" title="<?php echo $label_language_values['extra_service_title']; ?>"><?php echo $arrs['addon_service_name']; ?></span>                    
         </div>
         <div class="pull-right cta-col5">
            <div class="cta-col2">                            
              <span class="d4m-service-addon-price" title="<?php echo $label_language_values['basic_price']; ?>"><span class="price-currency"></span>
              <?php echo $general->d4mprice_format($arrs['base_price'], $symbol_position, $decimal); ?></span>                        
            </div>
            <div class="cta-col3">                            
              <label for="sevice-endis-<?php echo $i; ?>">                                              <input class='myservices_addons_status' data-toggle="toggle" data-size="small" type='checkbox' data-id="<?php echo $arrs['id']; ?>" <?php if ($arrs['status'] == 'E')
        {
        ...
        if ($t > 0)
        { ?>                           <a data-toggle="popover" class="delete-clean-service-btn pull-right btn-circle btn-danger btn-sm" rel="popover" data-placement='top' title="<?php echo $label_language_values['addon_is_booked']; ?>"> <i class="fa fa-ban"></i></a>                        <?php
        }
        else
        { ?>                                <a id="d4m-delete-service" data-toggle="popover"                                   class="delete-clean-service-btn pull-right btn-circle btn-danger btn-sm"                                   rel="popover" data-placement='left' title="<?php echo $label_language_values['delete_this_addon_service']; ?>"> <i class="fa fa-trash" title="<?php echo $label_language_values['delete_service']; ?>"></i></a>                                
                  <div id="popover-delete-service" style="display: none;">
                     <div class="arrow"></div>
                     <table class="form-horizontal" cellspacing="0">
                        <tbody>
                           <tr>
                              <td>                                                <button data-serviceaddonid="<?php echo $arrs['id']; ?>" value="Delete" class="btn btn-danger btn-sm service-addons-delete-button" data-imagename="<?php echo $arrs['image']; ?>" type="submit"><?php echo $label_language_values['yes']; ?>                                                </button>                                                <button id="d4m-close-popover-delete-service-addon" class="btn btn-default btn-sm" href="javascript:void(0)"><?php echo $label_language_values['cancel']; ?>                                                </button>                                            </td>
                           </tr>
                        </tbody>
                     </table>
                  </div>
   ...
   <div id="details_sp<?php echo $arrs['id']; ?>" class="serviceaddon_detail panel-collapse collapse">
      <div class="panel-body">
         <div class="d4m-service-collapse-div col-sm-12 col-md-6 col-lg-6 col-xs-12">
            <form id="myformedt_addons_<?php echo $arrs['id']; ?>" method="post" type="" class="slide-toggle">
               <table class="d4m-create-service-table">
                  <tbody>
                     <tr>
                        <td><label for="d4m-service-title"><?php echo $label_language_values['addon_title']; ?></label></td>
                        <td>
                     ...
                     <tr>                
                     <tr>
                        <td><label for="d4m-service-desc"> Addon Description</label></td>
                        <td>
                     ...
                     <td><label for="addon_hours"><?php echo $label_language_values['duration']; ?></label></td>
        ...
        $modulas = fmod($duration, 60); ?>                                                      
                     ...
                     <tr>
                        <td><label for="d4m-service-desc"><?php echo $label_language_values['service_image']; ?></label></td>
                        <td>
                           <div class="d4m-clean-service-addons-image-uploader">
                              <?php if ($arrs['image'] == '')
        {
        ...
        } ?>                                            <img data-imagename="" id="pcaol<?php echo $arrs['id']; ?>addonimage" src="<?php echo $imagepath; ?>" class="d4m-clean-service-addons-image br-100" height="100" width="100">                                 <?php if ($arrs['image'] == '')
        { ?>                                 <label for="d4m-upload-imagepcaol<?php echo $arrs['id']; ?>" class="d4m-clean-service-addons-img-icon-label ser_addons<?php echo $arrs['id']; ?>">                                                <i class="d4m-camera-icon-common br-100 fa fa-camera"></i>                                                <i class="pull-left fa fa-plus-circle fa-2x"></i>                                            </label>                               <?php
        } ?>                                            <input data-us="pcaol<?php echo $arrs['id']; ?>" data-id="<?php echo $arrs['id']; ?>" class="hide d4m-upload-images" type="file" name="" id="d4m-upload-imagepcaol<?php echo $arrs['id']; ?>" />                                 <label for="d4m-upload-imagepcaol<?php echo $arrs['id']; ?>" class="d4m-clean-service-addons-img-icon-label addon_ser_cam cam_btn_addon<?php echo $arrs['id']; ?>">                                                <i class="d4m-camera-icon-common br-100 fa fa-camera"></i>                                                <i class="pull-left fa fa-plus-circle fa-2x"></i>                                            </label>                                <?php if ($arrs['image'] !== '')
        { ?>                                            <a data-pcaolid="<?php echo $arrs['id']; ?>" id="d4m-remove-service-addons-imagepcaol<?php echo $arrs['id']; ?>" class="pull-left br-100 btn-danger bt-remove-service-addons-img btn-xs addons_del_btn addons_del_icon<?php echo $arrs['id']; ?>" rel="popover" data-placement='left' title="<?php echo $label_language_values['remove_image']; ?>"> <i class="fa fa-trash" title="<?php echo $label_language_values['remove_service_image']; ?>"></i></a>                                            <?php
                              ...
                              <div id="popover-d4m-remove-service-addons-imagepcaol<?php echo $arrs['id']; ?>" style="display: none;">
                                 <div class="arrow"></div>
                                 <table class="form-horizontal" cellspacing="0">
                                    <tbody>
                                       <tr>
                                          <td>                                                            <a href="javascript:void(0)" id="" value="Delete" class="btn btn-danger btn-sm delete_image_addons" data-pcaolid="<?php echo $arrs['id']; ?>" type="submit"><?php echo $label_language_values['yes']; ?></a>                                                            <a href="javascript:void(0)" id="d4m-close-popover-service-image" class="btn btn-default btn-sm" href="javascript:void(0)"><?php echo $label_language_values['cancel']; ?></a>                                                        </td>
                                       </tr>
                                    </tbody>
                                 </table>
                              </div>
        ...
        { ?>                                             
                                    <div class="cta-addons-list" id="addonid_<?php echo $arrs['id']; ?>" data-name="" data-p_i_name="">
                                       ...
                                       <h3 class="cta-addons-name"><?php echo $label_language_values['seled4maddon_image']; ?></h3>
                                    </div>
                                    <?php
        } ?>                                                                              
                                 </div>
                                 <div class="cta-addons-dropdown display_update_<?php echo $arrs['id']; ?>" >
                                    <div class="cta-addons-list seled4maddons" data-id="<?php echo $arrs['id']; ?>" data-name="d4m-icon-fridge.png" data-p_i_name="<?php echo $label_language_values['inside_fridge']; ?>">
                                       <img class="cta-addons-image" src="../assets/images/addons-images/d4m-icon-fridge.png" title="<?php echo $label_language_values['addon_image']; ?>" />                                                        
                                       <h3 class="cta-addons-name"><?php echo $label_language_values['inside_fridge']; ?></h3>
                                    </div>
                                    <div class="cta-addons-list seled4maddons"  data-id="<?php echo $arrs['id']; ?>" data-name="d4m-icon-oven.png" data-p_i_name="<?php echo $label_language_values['inside_oven']; ?>">
                                       <img class="cta-addons-image" src="../assets/images/addons-images/d4m-icon-oven.png" title="<?php echo $label_language_values['addon_image']; ?>" />                                                        
                                       <h3 class="cta-addons-name"><?php echo $label_language_values['inside_oven']; ?></h3>
                                    </div>
                                    <div class="cta-addons-list seled4maddons" data-id="<?php echo $arrs['id']; ?>" data-name="d4m-icon-inside-window.png" data-p_i_name="<?php echo $label_language_values['inside_windows']; ?>">
                                       <img class="cta-addons-image" src="../assets/images/addons-images/d4m-icon-inside-window.png" title="<?php echo $label_language_values['addon_image']; ?>" />                                                        
                                       <h3 class="cta-addons-name"><?php echo $label_language_values['inside_windows']; ?></h3>
                                    </div>
                                    <div class="cta-addons-list seled4maddons" data-id="<?php echo $arrs['id']; ?>" data-name="d4m-icon-carpet.png" data-p_i_name="<?php echo $label_language_values['carpet_cleaning']; ?>">
                                       <img class="cta-addons-image" src="../assets/images/addons-images/d4m-icon-carpet.png" title="<?php echo $label_language_values['addon_image']; ?>" />                                                        
                                       <h3 class="cta-addons-name"><?php echo $label_language_values['carpet_cleaning']; ?></h3>
                                    </div>
                                    <div class="cta-addons-list seled4maddons" data-id="<?php echo $arrs['id']; ?>" data-name="d4m-icon-green-cleaning.png" data-p_i_name="<?php echo $label_language_values['green_cleaning']; ?>">
                                       <img class="cta-addons-image" src="../assets/images/addons-images/d4m-icon-green-cleaning.png" title="<?php echo $label_language_values['addon_image']; ?>" />                                                        
                                       <h3 class="cta-addons-name"><?php echo $label_language_values['green_cleaning']; ?></h3>
                                    </div>
                                    <div class="cta-addons-list seled4maddons" data-id="<?php echo $arrs['id']; ?>" data-name="d4m-icon-pets.png" data-p_i_name="<?php echo $label_language_values['pets_care']; ?>">
                                       <img class="cta-addons-image" src="../assets/images/addons-images/d4m-icon-pets.png" title="<?php echo $label_language_values['addon_image']; ?>" />                                                        
                                       <h3 class="cta-addons-name"><?php echo $label_language_values['pets_care']; ?></h3>
                                    </div>
                                    <div class="cta-addons-list seled4maddons" data-id="<?php echo $arrs['id']; ?>" data-name="d4m-icon-tiles.png" data-p_i_name="<?php echo $label_language_values['tiles_cleaning']; ?>">
                                       <img class="cta-addons-image" src="../assets/images/addons-images/d4m-icon-tiles.png" title="<?php echo $label_language_values['addon_image']; ?>" />                                                        
                                       <h3 class="cta-addons-name"><?php echo $label_language_values['tiles_cleaning']; ?></h3>
                                    </div>
                                    <div class="cta-addons-list seled4maddons" data-id="<?php echo $arrs['id']; ?>" data-name="d4m-icon-wall-cleaning.png" data-p_i_name="<?php echo $label_language_values['wall_cleaning']; ?>">
                                       <img class="cta-addons-image" src="../assets/images/addons-images/d4m-icon-wall-cleaning.png" title="<?php echo $label_language_values['addon_image']; ?>" />                                                        
                                       <h3 class="cta-addons-name"><?php echo $label_language_values['wall_cleaning']; ?></h3>
                                    </div>
                                    <div class="cta-addons-list seled4maddons" data-id="<?php echo $arrs['id']; ?>" data-name="d4m-icon-laundry.png" data-p_i_name="<?php echo $label_language_values['laundry']; ?>">
                                       <img class="cta-addons-image" src="../assets/images/addons-images/d4m-icon-laundry.png" title="<?php echo $label_language_values['addon_image']; ?>" />                                                        
                                       <h3 class="cta-addons-name"><?php echo $label_language_values['laundry']; ?></h3>
                                    </div>
                                    <div class="cta-addons-list seled4maddons" data-id="<?php echo $arrs['id']; ?>" data-name="d4m-icon-basement.png" data-p_i_name="<?php echo $label_language_values['basement_cleaning']; ?>">
                                       <img class="cta-addons-image" src="../assets/images/addons-images/d4m-icon-basement.png" title="<?php echo $label_language_values['addon_image']; ?>" />                                                        
                                       <h3 class="cta-addons-name"><?php echo $label_language_values['basement_cleaning']; ?></h3>
                                    </div>
                                 </div>
                              </div>
                           </div>
                           <div id="d4m-image-upload-popuppcaol<?php echo $arrs['id']; ?>" class="d4m-image-upload-popup modal fade" tabindex="-1" role="dialog">
                              <div class="vertical-alignment-helper">
                                 <div class="modal-dialog modal-md vertical-align-center">
                                    <div class="modal-content">
                                       <div class="modal-header">
                                          <div class="col-md-12 col-xs-12">                                                                <a data-us="pcaol<?php echo $arrs['id']; ?>" class="btn btn-success d4mupload_img2" data-imageinputid="d4m-upload-imagepcaol<?php echo $arrs['id']; ?>" data-id="<?php echo $arrs['id']; ?>" ><?php echo $label_language_values['crop_and_save']; ?></a>                                                                <button type="button" class="btn btn-default hidemodal" data-dismiss="modal" aria-hidden="true"><?php echo $label_language_values['cancel']; ?></button>                                                            </div>
                                       </div>
                                       <div class="modal-body">                                                            <img id="d4m-preview-imgpcaol<?php echo $arrs['id']; ?>" />                                                        </div>
                     ...
                     <tr>
                        <td><label for="d4m-service-price"><?php echo $label_language_values['basic_price']; ?></label></td>
                        <td>
                           <div class="col-xs-12 np">
                              <div class="input-group">                                                <span class="input-group-addon"><?php echo $settings->get_option('d4mcurrency_symbol'); ?></span>                                                <input type="text" id="myedtaddon_baseprice<?php echo $arrs['id']; ?>" name = "myedtaddon_baseprice<?php echo $arrs['id']; ?>" class="form-control txtedtaddon_baseprice<?php echo $arrs['id']; ?>" placeholder="US Dollar" value="<?php echo $arrs['base_price']; ?>">                                            </div>
                              <label for="myedtaddon_baseprice<?php echo $arrs['id']; ?>" generated="true" class="error"></label>                                        
                           </div>
                        </td>
                     </tr>
                     <tr>
                        <td><label for="d4m-service-title"><?php echo $label_language_values['max_qty']; ?></label></td>
                        <td>
                     ...
                     <tr>
                        ...
                        <td>                                        <label for="addon-multi-qty<?php echo $i; ?>">                                 <input class='txtedtaddon_multipleqty' data-toggle="toggle" data-size="small" type='checkbox' data-id="<?php echo $arrs['id']; ?>" <?php if ($arrs['multipleqty'] == 'Y')
        {
            echo "checked";
        }
        else
        {
            echo "";
                     ...
                     <tr>
                        <td></td>
                        <td>                             <a data-id="<?php echo $arrs['id']; ?>" class="btn btn-success d4m-btn-width  btneditaddon_service"><?php echo $label_language_values['update']; ?>                            </a>                             <button type="reset" class="btn btn-default d4m-btn-width ml-30"><?php echo $label_language_values['reset']; ?></button>                         </td>
                     </tr>
                  </tbody>
               </table>
            </form>
         </div>
         <div class="d4m-service-collapse-div col-sm-12 col-md-6 col-lg-6 col-xs-12 manage-addon-price-container<?php echo $arrs['id']; ?>" style="display:<?php if ($settings->get_option('d4mcalculation_policy') == "M")
        {
            echo "none";
        }
        else
        ...
        { ?>                                            
                     <li class="form-group myaddon-qty_price_row<?php echo $r['id']; ?>">
                        <form id="myedtform_addonunits<?php echo $r['id']; ?>">
                           <label class="col-sm-2 col-xs-12" for="addon_qty_6"><?php echo $label_language_values['Quantity']; ?></label>                                                    
...
<li class="new-addon-scroll">
   ...
   <div class="panel panel-default d4m-clean-services-panel d4m-add-new-service cta-add-new-addon">
      <div class="panel-heading">
         <h4 class="panel-title">
            <div class="cta-col8">
               <div class="pull-left">                            <i class="fa fa-th-list"></i>                        </div>
               <span class="d4m-service-title-name"></span>                    
            </div>
               ...
               <form id="mynewformfor_insertaddons" method="post" type="" class="slide-toggle">
                  <table class="d4m-create-service-table">
                     <tbody>
                        ...
                        <tr>
                           <td><label for="d4m-service-hours"><?php echo $label_language_values['duration']; ?></label></td>
                           <td>
                        ...
                        <tr>
                           ...
                           <td>
                              <div class="d4m-clean-service-addons-image-uploader">
                                 <img id="pcaoaddonimage" src="../assets/images/default_service.png" class="d4m-clean-service-addons-image br-100" height="100" width="100">                                            <label for="d4m-upload-imagepcao" class="d4m-clean-service-addons-img-icon-label">                                                <i class="d4m-camera-icon-common br-100 fa fa-camera"></i>                                                <i class="pull-left fa fa-plus-circle fa-2x"></i>                                            </label>                                            <input data-us="pcao" class="hide d4m-upload-images" type="file" name="" id="d4m-upload-imagepcao" />                                            <a id="d4m-remove-service-addons-imagepcao" class="pull-left br-100 btn-danger bt-remove-service-addons-img btn-xs hide" rel="popover" data-placement='left' title="<?php echo $label_language_values['remove_image']; ?>"> <i class="fa fa-trash" title="<?php echo $label_language_values['remove_image']; ?>"></i></a>                                            
                                 <div id="popover-d4m-remove-service-addons-image" style="display: none;">
                                    <div class="arrow"></div>
                                    <table class="form-horizontal" cellspacing="0">
                                       <tbody>
                                          <tr>
                                             <td>                                                            <a href="javascript:void(0)" id="" value="Delete" class="btn btn-danger btn-sm" type="submit"><?php echo $label_language_values['yes']; ?></a>                                                            <a href="javascript:void(0)" id="d4m-close-popover-service-image" class="btn btn-default btn-sm" href="javascript:void(0)"><?php echo $label_language_values['cancel']; ?></a>                                                        </td>
                                          </tr>
                                       </tbody>
                                    </table>
                                 </div>
                              ...
                              <div class="cta-addons-imagelist-dropdown fl">
                                 <div class="cta-addons-selection-main">
                                    ...
                                    <div class="cta-addons-dropdown display_insert">
                                       <div class="cta-addons-list seled4maddons_insert" data-name="d4m-icon-fridge.png" data-p_i_name="<?php echo $label_language_values['inside_fridge']; ?>">
                                          <img class="cta-addons-image" src="../assets/images/addons-images/d4m-icon-fridge.png" title="<?php echo $label_language_values['addon_image']; ?>" />                                        
                                          <h3 class="cta-addons-name"><?php echo $label_language_values['inside_fridge']; ?></h3>
                                       </div>
                                       <div class="cta-addons-list seled4maddons_insert" data-name="d4m-icon-oven.png" data-p_i_name="<?php echo $label_language_values['inside_oven']; ?>">
                                          <img class="cta-addons-image" src="../assets/images/addons-images/d4m-icon-oven.png" title="<?php echo $label_language_values['addon_image']; ?>" />                                          
                                          <h3 class="cta-addons-name"><?php echo $label_language_values['inside_oven']; ?></h3>
                                       </div>
                                       <div class="cta-addons-list seled4maddons_insert" data-name="d4m-icon-inside-window.png" data-p_i_name="<?php echo $label_language_values['inside_windows']; ?>">
                                          <img class="cta-addons-image" src="../assets/images/addons-images/d4m-icon-inside-window.png" title="<?php echo $label_language_values['addon_image']; ?>" />                                          
                                          <h3 class="cta-addons-name"><?php echo $label_language_values['inside_windows']; ?></h3>
                                       </div>
                                       <div class="cta-addons-list seled4maddons_insert" data-name="d4m-icon-carpet.png" data-p_i_name="<?php echo $label_language_values['carpet_cleaning']; ?>">
                                          <img class="cta-addons-image" src="../assets/images/addons-images/d4m-icon-carpet.png" title="<?php echo $label_language_values['addon_image']; ?>" />                                        
                                          <h3 class="cta-addons-name"><?php echo $label_language_values['carpet_cleaning']; ?></h3>
                                       </div>
                                       <div class="cta-addons-list seled4maddons_insert" data-name="d4m-icon-green-cleaning.png" data-p_i_name="<?php echo $label_language_values['green_cleaning']; ?>">
                                          <img class="cta-addons-image" src="../assets/images/addons-images/d4m-icon-green-cleaning.png" title="<?php echo $label_language_values['addon_image']; ?>" />                                         
                                          <h3 class="cta-addons-name"><?php echo $label_language_values['green_cleaning']; ?></h3>
                                       </div>
                                       <div class="cta-addons-list seled4maddons_insert" data-name="d4m-icon-pets.png" data-p_i_name="<?php echo $label_language_values['pets_care']; ?>">
                                          <img class="cta-addons-image" src="../assets/images/addons-images/d4m-icon-pets.png" title="<?php echo $label_language_values['addon_image']; ?>" />                                          
                                          <h3 class="cta-addons-name"><?php echo $label_language_values['pets_care']; ?></h3>
                                       </div>
                                       <div class="cta-addons-list seled4maddons_insert" data-name="d4m-icon-tiles.png" data-p_i_name="<?php echo $label_language_values['tiles_cleaning']; ?>">
                                          <img class="cta-addons-image" src="../assets/images/addons-images/d4m-icon-tiles.png" title="<?php echo $label_language_values['addon_image']; ?>" />                                         
                                          <h3 class="cta-addons-name"><?php echo $label_language_values['tiles_cleaning']; ?></h3>
                                       </div>
                                       <div class="cta-addons-list seled4maddons_insert" data-name="d4m-icon-wall-cleaning.png" data-p_i_name="<?php echo $label_language_values['wall_cleaning']; ?>">
                                          <img class="cta-addons-image" src="../assets/images/addons-images/d4m-icon-wall-cleaning.png" title="<?php echo $label_language_values['addon_image']; ?>" />                                          
                                          <h3 class="cta-addons-name"><?php echo $label_language_values['wall_cleaning']; ?></h3>
                                       </div>
                                       <div class="cta-addons-list seled4maddons_insert" data-name="d4m-icon-laundry.png" data-p_i_name="<?php echo $label_language_values['laundry']; ?>">
                                          <img class="cta-addons-image" src="../assets/images/addons-images/d4m-icon-laundry.png" title="<?php echo $label_language_values['addon_image']; ?>" />                                          
                                          <h3 class="cta-addons-name"><?php echo $label_language_values['laundry']; ?></h3>
                                       </div>
                                       <div class="cta-addons-list seled4maddons_insert" data-name="d4m-icon-basement.png" data-p_i_name="<?php echo $label_language_values['basement_cleaning']; ?>">
                                          <img class="cta-addons-image" src="../assets/images/addons-images/d4m-icon-basement.png" title="<?php echo $label_language_values['addon_image']; ?>" />                                         
                                          <h3 class="cta-addons-name"><?php echo $label_language_values['basement_cleaning']; ?></h3>
                                       </div>
                                    </div>
                              ...
                              <div id="d4m-image-upload-popuppcao" class="d4m-image-upload-popup modal fade" tabindex="-1" role="dialog">
                                 <div class="vertical-alignment-helper">
                                    <div class="modal-dialog modal-md vertical-align-center">
                                       <div class="modal-content">
                                          <div class="modal-header">
                                             <div class="col-md-12 col-xs-12">                                                                <a data-us="pcao" class="btn btn-success d4mupload_img2" data-imageinputid="d4m-upload-imagepcao"><?php echo $label_language_values['crop_and_save']; ?></a>                                                                <button type="button" class="btn btn-default hidemodal" data-dismiss="modal" aria-hidden="true"><?php echo $label_language_values['cancel']; ?></button>                                                            </div>
                                          </div>
                                          <div class="modal-body">                                                            <img id="d4m-preview-imgpcao" />                                                        </div>
                                          <div class="modal-footer">
                                             <div class="col-md-12 np">
                        ...
                        <tr>
                           ...
                           <td>
                              <div class="col-sm-4 col-xs-12 np">
                                 <div class="input-group">                                                <span class="input-group-addon"><?php echo $settings->get_option('d4mcurrency_symbol'); ?></span>                                                <input type="text" class="form-control txtaddon_baseprice" placeholder="US Dollar" id="mynewbasepricefor_addons" name="newssssprice_addon">                                            </div>
                        ...
                        <tr>
                           <td></td>
                           <td>                             <a name="asdad" class="btn btn-success d4m-btn-width  btnaddon_save"                                   type="submit"><?php echo $label_language_values['save']; ?>                            </a>                             <button type="reset" id="reset_service_addons" class="btn btn-default d4m-btn-width ml-30"><?php echo $label_language_values['reset']; ?></button>                          </td>
                        </tr>
                     </tbody>
                  </table>
            </div>
