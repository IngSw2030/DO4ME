...
if(((phpversion() >= '5.3') == false) || ((!ini_get('session_auto_start')) == false) || (extension_loaded('mysqli') == false) || (extension_loaded('zip') == false) || (extension_loaded('gd') == false) || ((extension_loaded('curl')) == false) || (is_writable('./../../config.php') == false)){
	...
	?>
		...
		<a href="javascript:void(0)" class="btn btn-success server_config_btn float-right next-btn">Next <i class="fa fa-angle-double-right"></i></a>
...
elseif(isset($_POST['server_config_next']) && $_POST['server_config_next']){
	...
	<div id="cti-content" class="col-md-8 col-sm-8 col-lg-8">
		...
		<div class="cti-progress-bar">Step <b>3</b> out of 5 - Database Information & Licence</div>
			...
			<form class="form-horizontal" id="d4mdb_form">
				...
				<div class="form-group">
					...
					<div class="col-xs-5">
						...
						<input type="text" class="form-control db_host" name="d4mdb_hostname" id="d4mdb_hostname" ><a class="cti-tooltip-link" tabindex="-1" href="javascript:void(0)" data-toggle="tooltip" title="Database host with port e.g 127.0.0.1:3306 or in most cases its 'localhost'"><i class="fa fa-info-circle"></i></a>
				...
				<div class="form-group">
					...
					<div class="col-xs-5">
						...
						<input type="text" class="form-control db_name" name="d4mdb_dbname" id="d4mdb_dbname" >
				...
				<div class="form-group">
					...
					<div class="col-xs-5">
						...
						<input type="text" class="form-control db_username" name="d4mdb_username" id="d4mdb_username" >
				...
				<div class="form-group">
					...
					<div class="col-xs-5">
						...
						<input type="password" class="form-control db_password" name="d4mdb_password" id="d4mdb_password" >
				...
				<div id="purchase-code-verification stop_this" class="purchase_code_text">
					...
					<div class="form-group">
						...
						<div class="col-xs-5">
							...
							<input type="text" class="form-control envato_code" name="d4mdb_envatocode" id="d4mdb_envatocode" >
				...
				<div class="form-group">
					...
					<div class="col-xs-offset-3 col-xs-10">
						...
						<a href="javascript:void(0)" class="btn btn-info database_check_con next-btn">Test Connection</a>
			...
			<a href="javascript:void(0)" class="btn btn-success database_check_next float-right next-btn">Next <i class="fa fa-angle-double-right"></i></a>
...
elseif(isset($_POST['db_check_next']) && $_POST['db_check_next'] == "1"){
	...
	if($conn->conned4merror)

	{

		ob_clean();ob_start();

		echo "<div class='alert alert-danger text-center'>Connection failed: " . $conn->conned4merror . "</div>";
...
elseif(isset($_POST['getadminlogin']) && $_POST['getadminlogin'] == "1"){
	...
	<div id="cti-content" class="col-md-8 col-sm-8 col-lg-8">
		...
		<form class="form-horizontal" id="d4madmin_detail_form">
			...
			<div class="form-group">
				...
				<div class="col-xs-5">
					...
					<input type="email" class="form-control admin_email" id="d4madmin_email" name="d4madmin_email"	 placeholder="Email"><a  tabindex="-1"  class="cti-tooltip-link" href="javascript:void(0)" data-toggle="tooltip" title="Please Set Your Username"><i class="fa fa-info-circle"></i></a>
			...
			<div class="form-group">
				...
				<div class="col-xs-5">
					...
					<input type="password" class="form-control admin_password" id="d4madmin_password" name="d4madmin_password" placeholder="Password"><a  tabindex="-1" class="cti-tooltip-link" href="javascript:void(0)" data-toggle="tooltip" title="Please Set Your Password"><i class="fa fa-info-circle"></i></a>

				</div>

			</div>

			<a href="javascript:void(0)" class="btn btn-success admin_credential_next float-right next-btn">Next <i class="fa  fa-angle-double-right"></i></a>
...
elseif(isset($_POST['add_admin']) && $_POST['add_admin'] == "1"){
...

	{
		...
		$_SESSION['d4madminid'] = $insertedadminid;

		$_SESSION['d4museremail'] = $_POST['admin_email'];

		$_SESSION['d4madmin_password']= $_POST['admin_password'];
	...
	<div id="cti-content" class="col-md-8 col-sm-8 col-lg-8">
		...
		<h4 class="text-success"> Woot..! do4me is installed and license is activated successfully !!</h4>

		<div class="cti-info"><b>Administrator's account has been successfully created.</b></div>

		<div class="cti-info">You can access do4me admin from <a href="admin/" target="_BLANK">here</a> and start configuring your new appointment tool.
			...
			<div class="cti-info">You can view booking from <a href="index.php" target="_BLANK">here</a>.
				...
				<div class="cti-info"><b>Login Credentials are: </b><br />
					...
					Email : <b><?php echo $_SESSION['d4museremail'];?></b><br />

					Password : <b><?php echo $_SESSION['d4madmin_password'];?></b>
				...
				<div class="cti-info">
					...
					Getting Started : <a href="https://skymoonlabs.ticksy.com/articles/100015682" target="_BLANK">Documentations</a> <br />
				...
				<div class="return_url">
					<a class="btn complete-btn" href="<?php echo SITE_URL;?>" target="_BLANK">Go to Booking Form</a>
					<a class="btn complete-btn" href="<?php echo SITE_URL.'admin';?>" target="_BLANK">Go to Admin Panel</a>
				</div>
