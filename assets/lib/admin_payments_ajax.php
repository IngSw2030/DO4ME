...
$setting->conn = $conn;
$getdateformat=$setting->get_option('d4mdate_picker_date_format');
$gettimeformat=$setting->get_option('d4mtime_format');
		...
		<tbody>
			...
			<tr>
				...
				<?php      
						...
						<td>
							<?php  if($rs['amount'] == 0){ echo "Free"; }else{echo  $general->d4mprice_format($rs['amount'],$symbol_position,$decimal);}?></td>
						<td>
							<?php  if($rs['frequently_discount'] == 'O')
                        {
                            echo $label_language_values['once']." - ".$general->d4mprice_format($rs['frequently_discount_amount'],$symbol_position,$decimal);
                        }
                        elseif($rs['frequently_discount'] == 'W')
                        {
                            echo $label_language_values['weekly']." - ".$general->d4mprice_format($rs['frequently_discount_amount'],$symbol_position,$decimal);
                        }
                        elseif($rs['frequently_discount'] == 'B')
                        {
                            echo $label_language_values['bi_weekly']." - ".$general->d4mprice_format($rs['frequently_discount_amount'],$symbol_position,$decimal);
                        }
                        elseif($rs['frequently_discount'] == 'M')
                        {
                            echo $label_language_values['monthly']." - ".$general->d4mprice_format($rs['frequently_discount_amount'],$symbol_position,$decimal);
                        }
                        else
                        {
					...
					<td>
						<?php  if($rs['discount'] == 0){ echo "Free"; }else{echo  $general->d4mprice_format($rs['discount'],$symbol_position,$decimal);}?></td>
					<td>
						<?php  if($rs['taxes'] == 0){ echo "Free"; }else{echo  $general->d4mprice_format($rs['taxes'],$symbol_position,$decimal);}?></td>
					<td>
						<?php  if($rs['net_amount'] == 0){ echo "Free"; }else{echo  $general->d4mprice_format($rs['net_amount'],$symbol_position,$decimal);}?></td>
					<td>
						<?php  if($rs['partial_amount'] == 0){ echo "Free"; }else{echo  $general->d4mprice_format($rs['partial_amount'],$symbol_position,$decimal);}?></td>
					<?php 
                }
                else{
                    ?>
					...
					<td>
						<?php  echo  $general->d4mprice_format($rs['amount'],$symbol_position,$decimal);?></td>
					<td>
						<?php  if($rs['frequently_discount'] == 'O')
					{
						echo $label_language_values['once']." - ".$general->d4mprice_format($rs['frequently_discount_amount'],$symbol_position,$decimal);
					...
					<td>
						<?php  echo  $rs['discount']==0?"-":$general->d4mprice_format($rs['discount'],$symbol_position,$decimal);?></td>
					<td>
						<?php  echo  $rs['taxes']==0?"-":$general->d4mprice_format($rs['taxes'],$symbol_position,$decimal);?></td>
					<td>
						<?php  echo  $rs['net_amount']==0?"-":$general->d4mprice_format($rs['net_amount'],$symbol_position,$decimal);?></td>
					<td>
						<?php  echo  $rs['partial_amount']==0?"-":$general->d4mprice_format($rs['partial_amount'],$symbol_position,$decimal);?></td>
					<?php 
                }
                ?>
								</tr>
...
if(isset($_POST['update_payment_status'])){
	...
	$update_status = $_POST['update_current_status'];
	echo $r = $objpayment->update_payment_status($order_id,$update_status);
