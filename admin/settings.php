...
$admin_profile->id = $_SESSION['ct_adminid'];
...
<div class="panel cta-panel-default" id="ct-settings">
            ...
            <div class="company-details tab-pane fade in active" id="company-details">
                <form id="business_setting_form" method="post" type="" class="ct-company-details" >
                    <div class="panel panel-default">
                        ...
                        <option <?php if($setting->get_option('ct_timezone')=='Pacific/Niue'){ echo "selected"; } ?> value="Pacific/Niue" data-posinset="3">(GMT-11:00) Niue Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Pacific/Pago_Pago'){ echo "selected"; } ?> value="Pacific/Pago_Pago" data-posinset="4">(GMT-11:00) Samoa Standard Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Pacific/Rarotonga'){ echo "selected"; } ?> value="Pacific/Rarotonga" data-posinset="5">(GMT-10:00) Cook Islands Standard Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Pacific/Honolulu'){ echo "selected"; } ?> value="Pacific/Honolulu" data-posinset="6">(GMT-10:00) Hawaii-Aleutian Standard Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Pacific/Tahiti'){ echo "selected"; } ?> value="Pacific/Tahiti" data-posinset="7">(GMT-10:00) Tahiti Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Pacific/Marquesas'){ echo "selected"; } ?> value="Pacific/Marquesas" data-posinset="8">(GMT-09:30) Marquesas Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Pacific/Gambier'){ echo "selected"; } ?> value="Pacific/Gambier" data-posinset="9">(GMT-09:30) Gambier Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Anchorage'){ echo "selected"; } ?> value="America/Anchorage" data-posinset="10">(GMT-08:00) Alaska Time - Anchorage</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Pacific/Pitcairn'){ echo "selected"; } ?> value="Pacific/Pitcairn" data-posinset="11">(GMT-08:00) Pitcairn Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Hermosillo'){ echo "selected"; } ?> value="America/Hermosillo" data-posinset="12">(GMT-07:00) Mexican Pacific Standard Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Dawson_Creek'){ echo "selected"; } ?> value="America/Dawson_Creek" data-posinset="13">(GMT-07:00) Mountain Standard Time - Dawson Creek</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Phoenix'){ echo "selected"; } ?> value="America/Phoenix" data-posinset="14">(GMT-07:00) Mountain Standard Time - Phoenix</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Dawson'){ echo "selected"; } ?> value="America/Dawson" data-posinset="15">(GMT-07:00) Pacific Time - Dawson</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Los_Angeles'){ echo "selected"; } ?> value="America/Los_Angeles" data-posinset="16">(GMT-07:00) Pacific Time - Los Angeles</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Tijuana'){ echo "selected"; } ?> value="America/Tijuana" data-posinset="17">(GMT-07:00) Pacific Time - Tijuana</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Vancouver'){ echo "selected"; } ?> value="America/Vancouver" data-posinset="18">(GMT-07:00) Pacific Time - Vancouver</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Whitehorse'){ echo "selected"; } ?> value="America/Whitehorse" data-posinset="19">(GMT-07:00) Pacific Time - Whitehorse</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Belize'){ echo "selected"; } ?> value="America/Belize" data-posinset="20">(GMT-06:00) Central Standard Time - Belize</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Costa_Rica'){ echo "selected"; } ?> value="America/Costa_Rica" data-posinset="21">(GMT-06:00) Central Standard Time - Costa Rica</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/El_Salvador'){ echo "selected"; } ?> value="America/El_Salvador" data-posinset="22">(GMT-06:00) Central Standard Time - El Salvador</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Guatemala'){ echo "selected"; } ?> value="America/Guatemala" data-posinset="23">(GMT-06:00) Central Standard Time - Guatemala</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Managua'){ echo "selected"; } ?> value="America/Managua" data-posinset="24">(GMT-06:00) Central Standard Time - Managua</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Regina'){ echo "selected"; } ?> value="America/Regina" data-posinset="25">(GMT-06:00) Central Standard Time - Regina</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Tegucigalpa'){ echo "selected"; } ?> value="America/Tegucigalpa" data-posinset="26">(GMT-06:00) Central Standard Time - Tegucigalpa</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Pacific/Easter'){ echo "selected"; } ?> value="Pacific/Easter" data-posinset="27">(GMT-06:00) Easter Island Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Pacific/Galapagos'){ echo "selected"; } ?> value="Pacific/Galapagos" data-posinset="28">(GMT-06:00) Galapagos Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Mazatlan'){ echo "selected"; } ?> value="America/Mazatlan" data-posinset="29">(GMT-06:00) Mexican Pacific Time - Mazatlan</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Boise'){ echo "selected"; } ?> value="America/Boise" data-posinset="30">(GMT-06:00) Mountain Time - Boise</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Denver'){ echo "selected"; } ?> value="America/Denver" data-posinset="31">(GMT-06:00) Mountain Time - Denver</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Edmonton'){ echo "selected"; } ?> value="America/Edmonton" data-posinset="32">(GMT-06:00) Mountain Time - Edmonton</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Yellowknife'){ echo "selected"; } ?> value="America/Yellowknife" data-posinset="33">(GMT-06:00) Mountain Time - Yellowknife</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Rio_Branco'){ echo "selected"; } ?> value="America/Rio_Branco" data-posinset="34">(GMT-05:00) Acre Standard Time - Rio Branco</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Chicago'){ echo "selected"; } ?> value="America/Chicago" data-posinset="35">(GMT-05:00) Central Time - Chicago</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Mexico_City'){ echo "selected"; } ?> value="America/Mexico_City" data-posinset="36">(GMT-05:00) Central Time - Mexico City</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Winnipeg'){ echo "selected"; } ?> value="America/Winnipeg" data-posinset="37">(GMT-05:00) Central Time - Winnipeg</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Bogota'){ echo "selected"; } ?> value="America/Bogota" data-posinset="38">(GMT-05:00) Colombia Standard Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Cancun'){ echo "selected"; } ?> value="America/Cancun" data-posinset="39">(GMT-05:00) Eastern Standard Time - Cancun</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Jamaica'){ echo "selected"; } ?> value="America/Jamaica" data-posinset="40">(GMT-05:00) Eastern Standard Time - Jamaica</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Panama'){ echo "selected"; } ?> value="America/Panama" data-posinset="41">(GMT-05:00) Eastern Standard Time - Panama</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Guayaquil'){ echo "selected"; } ?> value="America/Guayaquil" data-posinset="42">(GMT-05:00) Ecuador Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Lima'){ echo "selected"; } ?> value="America/Lima" data-posinset="43">(GMT-05:00) Peru Standard Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Boa_Vista'){ echo "selected"; } ?> value="America/Boa_Vista" data-posinset="44">(GMT-04:00) Amazon Standard Time - Boa Vista</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Manaus'){ echo "selected"; } ?> value="America/Manaus" data-posinset="45">(GMT-04:00) Amazon Standard Time - Manaus</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Porto_Velho'){ echo "selected"; } ?> value="America/Porto_Velho" data-posinset="46">(GMT-04:00) Amazon Standard Time - Porto Velho</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Campo_Grande'){ echo "selected"; } ?> value="America/Campo_Grande" data-posinset="47">(GMT-04:00) Amazon Time - Campo Grande</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Cuiaba'){ echo "selected"; } ?> value="America/Cuiaba" data-posinset="48">(GMT-04:00) Amazon Time - Cuiaba</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Barbados'){ echo "selected"; } ?> value="America/Barbados" data-posinset="49">(GMT-04:00) Atlantic Standard Time - Barbados</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Curacao'){ echo "selected"; } ?> value="America/Curacao" data-posinset="50">(GMT-04:00) Atlantic Standard Time - Curaçao</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Martinique'){ echo "selected"; } ?> value="America/Martinique" data-posinset="51">(GMT-04:00) Atlantic Standard Time - Martinique</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Port_of_Spain'){ echo "selected"; } ?> value="America/Port_of_Spain" data-posinset="52">(GMT-04:00) Atlantic Standard Time - Port of Spain</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Puerto_Rico'){ echo "selected"; } ?> value="America/Puerto_Rico" data-posinset="53">(GMT-04:00) Atlantic Standard Time - Puerto Rico</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Santo_Domingo'){ echo "selected"; } ?> value="America/Santo_Domingo" data-posinset="54">(GMT-04:00) Atlantic Standard Time - Santo Domingo</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/La_Paz'){ echo "selected"; } ?> value="America/La_Paz" data-posinset="55">(GMT-04:00) Bolivia Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Santiago'){ echo "selected"; } ?> value="America/Santiago" data-posinset="56">(GMT-04:00) Chile Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Havana'){ echo "selected"; } ?> value="America/Havana" data-posinset="57">(GMT-04:00) Cuba Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Detroit'){ echo "selected"; } ?> value="America/Detroit" data-posinset="58">(GMT-04:00) Eastern Time - Detroit</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Grand_Turk'){ echo "selected"; } ?> value="America/Grand_Turk" data-posinset="59">(GMT-04:00) Eastern Time - Grand Turk</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Iqaluit'){ echo "selected"; } ?> value="America/Iqaluit" data-posinset="60">(GMT-04:00) Eastern Time - Iqaluit</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Nassau'){ echo "selected"; } ?> value="America/Nassau" data-posinset="61">(GMT-04:00) Eastern Time - Nassau</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/New_York'){ echo "selected"; } ?> value="America/New_York" data-posinset="62">(GMT-04:00) Eastern Time - New York</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Port-au-Prince'){ echo "selected"; } ?> value="America/Port-au-Prince" data-posinset="63">(GMT-04:00) Eastern Time - Port-au-Prince</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Toronto'){ echo "selected"; } ?> value="America/Toronto" data-posinset="64">(GMT-04:00) Eastern Time - Toronto</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Guyana'){ echo "selected"; } ?> value="America/Guyana" data-posinset="65">(GMT-04:00) Guyana Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Asuncion'){ echo "selected"; } ?> value="America/Asuncion" data-posinset="66">(GMT-04:00) Paraguay Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Caracas'){ echo "selected"; } ?> value="America/Caracas" data-posinset="67">(GMT-04:00) Venezuela Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Argentina/Buenos_Aires'){ echo "selected"; } ?> value="America/Argentina/Buenos_Aires" data-posinset="68">(GMT-03:00) Argentina Standard Time - Buenos Aires</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Argentina/Cordoba'){ echo "selected"; } ?> value="America/Argentina/Cordoba" data-posinset="69">(GMT-03:00) Argentina Standard Time - Cordoba</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Atlantic/Bermuda'){ echo "selected"; } ?> value="Atlantic/Bermuda" data-posinset="70">(GMT-03:00) Atlantic Time - Bermuda</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Halifax'){ echo "selected"; } ?> value="America/Halifax" data-posinset="71">(GMT-03:00) Atlantic Time - Halifax</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Thule'){ echo "selected"; } ?> value="America/Thule" data-posinset="72">(GMT-03:00) Atlantic Time - Thule</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Araguaina'){ echo "selected"; } ?> value="America/Araguaina" data-posinset="73">(GMT-03:00) Brasilia Standard Time - Araguaina</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Bahia'){ echo "selected"; } ?> value="America/Bahia" data-posinset="74">(GMT-03:00) Brasilia Standard Time - Bahia</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Belem'){ echo "selected"; } ?> value="America/Belem" data-posinset="75">(GMT-03:00) Brasilia Standard Time - Belem</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Fortaleza'){ echo "selected"; } ?> value="America/Fortaleza" data-posinset="76">(GMT-03:00) Brasilia Standard Time - Fortaleza</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Maceio'){ echo "selected"; } ?> value="America/Maceio" data-posinset="77">(GMT-03:00) Brasilia Standard Time - Maceio</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Recife'){ echo "selected"; } ?> value="America/Recife" data-posinset="78">(GMT-03:00) Brasilia Standard Time - Recife</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Sao_Paulo'){ echo "selected"; } ?> value="America/Sao_Paulo" data-posinset="79">(GMT-03:00) Brasilia Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Atlantic/Stanley'){ echo "selected"; } ?> value="Atlantic/Stanley" data-posinset="80">(GMT-03:00) Falkland Islands Standard Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Cayenne'){ echo "selected"; } ?> value="America/Cayenne" data-posinset="81">(GMT-03:00) French Guiana Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Antarctica/Palmer'){ echo "selected"; } ?> value="Antarctica/Palmer" data-posinset="82">(GMT-03:00) Palmer Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Punta_Arenas'){ echo "selected"; } ?> value="America/Punta_Arenas" data-posinset="83">(GMT-03:00) Punta Arenas Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Antarctica/Rothera'){ echo "selected"; } ?> value="Antarctica/Rothera" data-posinset="84">(GMT-03:00) Rothera Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Paramaribo'){ echo "selected"; } ?> value="America/Paramaribo" data-posinset="85">(GMT-03:00) Suriname Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Montevideo'){ echo "selected"; } ?> value="America/Montevideo" data-posinset="86">(GMT-03:00) Uruguay Standard Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/St_Johns'){ echo "selected"; } ?> value="America/St_Johns" data-posinset="87">(GMT-02:30) Newfoundland Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Noronha'){ echo "selected"; } ?> value="America/Noronha" data-posinset="88">(GMT-02:00) Fernando de Noronha Standard Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Atlantic/South_Georgia'){ echo "selected"; } ?> value="Atlantic/South_Georgia" data-posinset="89">(GMT-02:00) South Georgia Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Miquelon'){ echo "selected"; } ?> value="America/Miquelon" data-posinset="90">(GMT-02:00) St. Pierre &amp; Miquelon Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Godthab'){ echo "selected"; } ?> value="America/Godthab" data-posinset="91">(GMT-02:00) West Greenland Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Atlantic/Cape_Verde'){ echo "selected"; } ?> value="Atlantic/Cape_Verde" data-posinset="92">(GMT-01:00) Cape Verde Standard Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Atlantic/Azores'){ echo "selected"; } ?> value="Atlantic/Azores" data-posinset="93">(GMT+00:00) Azores Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Scoresbysund'){ echo "selected"; } ?> value="America/Scoresbysund" data-posinset="94">(GMT+00:00) East Greenland Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Etc/GMT'){ echo "selected"; } ?> value="Etc/GMT" data-posinset="95">(GMT+00:00) Greenwich Mean Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Africa/Abidjan'){ echo "selected"; } ?> value="Africa/Abidjan" data-posinset="96">(GMT+00:00) Greenwich Mean Time - Abidjan</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Africa/Accra'){ echo "selected"; } ?> value="Africa/Accra" data-posinset="97">(GMT+00:00) Greenwich Mean Time - Accra</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Africa/Bissau'){ echo "selected"; } ?> value="Africa/Bissau" data-posinset="98">(GMT+00:00) Greenwich Mean Time - Bissau</option>
                        <option <?php if($setting->get_option('ct_timezone')=='America/Danmarkshavn'){ echo "selected"; } ?> value="America/Danmarkshavn" data-posinset="99">(GMT+00:00) Greenwich Mean Time - Danmarkshavn</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Africa/Monrovia'){ echo "selected"; } ?> value="Africa/Monrovia" data-posinset="100">(GMT+00:00) Greenwich Mean Time - Monrovia</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Atlantic/Reykjavik'){ echo "selected"; } ?> value="Atlantic/Reykjavik" data-posinset="101">(GMT+00:00) Greenwich Mean Time - Reykjavik</option>
                        <option <?php if($setting->get_option('ct_timezone')=='UTC'){ echo "selected"; } ?> value="UTC" data-posinset="102">UTC</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Africa/Algiers'){ echo "selected"; } ?> value="Africa/Algiers" data-posinset="103">(GMT+01:00) Central European Standard Time - Algiers</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Africa/Tunis'){ echo "selected"; } ?> value="Africa/Tunis" data-posinset="104">(GMT+01:00) Central European Standard Time - Tunis</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Europe/Dublin'){ echo "selected"; } ?> value="Europe/Dublin" data-posinset="105">(GMT+01:00) Ireland Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Europe/London'){ echo "selected"; } ?> value="Europe/London" data-posinset="106">(GMT+01:00) United Kingdom Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Africa/Lagos'){ echo "selected"; } ?> value="Africa/Lagos" data-posinset="107">(GMT+01:00) West Africa Standard Time - Lagos</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Africa/Ndjamena'){ echo "selected"; } ?> value="Africa/Ndjamena" data-posinset="108">(GMT+01:00) West Africa Standard Time - Ndjamena</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Africa/Sao_Tome'){ echo "selected"; } ?> value="Africa/Sao_Tome" data-posinset="109">(GMT+01:00) West Africa Standard Time - São Tomé</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Atlantic/Canary'){ echo "selected"; } ?> value="Atlantic/Canary" data-posinset="110">(GMT+01:00) Western European Time - Canary</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Africa/Casablanca'){ echo "selected"; } ?> value="Africa/Casablanca" data-posinset="111">(GMT+01:00) Western European Time - Casablanca</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Africa/El_Aaiun'){ echo "selected"; } ?> value="Africa/El_Aaiun" data-posinset="112">(GMT+01:00) Western European Time - El Aaiun</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Atlantic/Faroe'){ echo "selected"; } ?> value="Atlantic/Faroe" data-posinset="113">(GMT+01:00) Western European Time - Faroe</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Europe/Lisbon'){ echo "selected"; } ?> value="Europe/Lisbon" data-posinset="114">(GMT+01:00) Western European Time - Lisbon</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Africa/Khartoum'){ echo "selected"; } ?> value="Africa/Khartoum" data-posinset="115">(GMT+02:00) Central Africa Time - Khartoum</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Africa/Maputo'){ echo "selected"; } ?> value="Africa/Maputo" data-posinset="116">(GMT+02:00) Central Africa Time - Maputo</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Africa/Windhoek'){ echo "selected"; } ?> value="Africa/Windhoek" data-posinset="117">(GMT+02:00) Central Africa Time - Windhoek</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Europe/Amsterdam'){ echo "selected"; } ?> value="Europe/Amsterdam" data-posinset="118">(GMT+02:00) Central European Time - Amsterdam</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Europe/Andorra'){ echo "selected"; } ?> value="Europe/Andorra" data-posinset="119">(GMT+02:00) Central European Time - Andorra</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Europe/Belgrade'){ echo "selected"; } ?> value="Europe/Belgrade" data-posinset="120">(GMT+02:00) Central European Time - Belgrade</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Europe/Berlin'){ echo "selected"; } ?> value="Europe/Berlin" data-posinset="121">(GMT+02:00) Central European Time - Berlin</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Europe/Brussels'){ echo "selected"; } ?> value="Europe/Brussels" data-posinset="122">(GMT+02:00) Central European Time - Brussels</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Europe/Budapest'){ echo "selected"; } ?> value="Europe/Budapest" data-posinset="123">(GMT+02:00) Central European Time - Budapest</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Africa/Ceuta'){ echo "selected"; } ?> value="Africa/Ceuta" data-posinset="124">(GMT+02:00) Central European Time - Ceuta</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Europe/Copenhagen'){ echo "selected"; } ?> value="Europe/Copenhagen" data-posinset="125">(GMT+02:00) Central European Time - Copenhagen</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Europe/Gibraltar'){ echo "selected"; } ?> value="Europe/Gibraltar" data-posinset="126">(GMT+02:00) Central European Time - Gibraltar</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Europe/Luxembourg'){ echo "selected"; } ?> value="Europe/Luxembourg" data-posinset="127">(GMT+02:00) Central European Time - Luxembourg</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Europe/Madrid'){ echo "selected"; } ?> value="Europe/Madrid" data-posinset="128">(GMT+02:00) Central European Time - Madrid</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Europe/Malta'){ echo "selected"; } ?> value="Europe/Malta" data-posinset="129">(GMT+02:00) Central European Time - Malta</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Europe/Monaco'){ echo "selected"; } ?> value="Europe/Monaco" data-posinset="130">(GMT+02:00) Central European Time - Monaco</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Europe/Oslo'){ echo "selected"; } ?> value="Europe/Oslo" data-posinset="131">(GMT+02:00) Central European Time - Oslo</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Europe/Paris'){ echo "selected"; } ?> value="Europe/Paris" data-posinset="132">(GMT+02:00) Central European Time - Paris</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Europe/Prague'){ echo "selected"; } ?> value="Europe/Prague" data-posinset="133">(GMT+02:00) Central European Time - Prague</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Europe/Rome'){ echo "selected"; } ?> value="Europe/Rome" data-posinset="134">(GMT+02:00) Central European Time - Rome</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Europe/Stockholm'){ echo "selected"; } ?> value="Europe/Stockholm" data-posinset="135">(GMT+02:00) Central European Time - Stockholm</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Europe/Tirane'){ echo "selected"; } ?> value="Europe/Tirane" data-posinset="136">(GMT+02:00) Central European Time - Tirane</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Europe/Vienna'){ echo "selected"; } ?> value="Europe/Vienna" data-posinset="137">(GMT+02:00) Central European Time - Vienna</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Europe/Warsaw'){ echo "selected"; } ?> value="Europe/Warsaw" data-posinset="138">(GMT+02:00) Central European Time - Warsaw</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Europe/Zurich'){ echo "selected"; } ?> value="Europe/Zurich" data-posinset="139">(GMT+02:00) Central European Time - Zurich</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Africa/Cairo'){ echo "selected"; } ?> value="Africa/Cairo" data-posinset="140">(GMT+02:00) Eastern European Standard Time - Cairo</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Europe/Kaliningrad'){ echo "selected"; } ?> value="Europe/Kaliningrad" data-posinset="141">(GMT+02:00) Eastern European Standard Time - Kaliningrad</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Africa/Tripoli'){ echo "selected"; } ?> value="Africa/Tripoli" data-posinset="142">(GMT+02:00) Eastern European Standard Time - Tripoli</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Africa/Johannesburg'){ echo "selected"; } ?> value="Africa/Johannesburg" data-posinset="143">(GMT+02:00) South Africa Standard Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Baghdad'){ echo "selected"; } ?> value="Asia/Baghdad" data-posinset="144">(GMT+03:00) Arabian Standard Time - Baghdad</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Qatar'){ echo "selected"; } ?> value="Asia/Qatar" data-posinset="145">(GMT+03:00) Arabian Standard Time - Qatar</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Riyadh'){ echo "selected"; } ?> value="Asia/Riyadh" data-posinset="146">(GMT+03:00) Arabian Standard Time - Riyadh</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Africa/Nairobi'){ echo "selected"; } ?> value="Africa/Nairobi" data-posinset="147">(GMT+03:00) East Africa Time - Nairobi</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Amman'){ echo "selected"; } ?> value="Asia/Amman" data-posinset="148">(GMT+03:00) Eastern European Time - Amman</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Europe/Athens'){ echo "selected"; } ?> value="Europe/Athens" data-posinset="149">(GMT+03:00) Eastern European Time - Athens</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Beirut'){ echo "selected"; } ?> value="Asia/Beirut" data-posinset="150">(GMT+03:00) Eastern European Time - Beirut</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Europe/Bucharest'){ echo "selected"; } ?> value="Europe/Bucharest" data-posinset="151">(GMT+03:00) Eastern European Time - Bucharest</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Europe/Chisinau'){ echo "selected"; } ?> value="Europe/Chisinau" data-posinset="152">(GMT+03:00) Eastern European Time - Chisinau</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Damascus'){ echo "selected"; } ?> value="Asia/Damascus" data-posinset="153">(GMT+03:00) Eastern European Time - Damascus</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Gaza'){ echo "selected"; } ?> value="Asia/Gaza" data-posinset="154">(GMT+03:00) Eastern European Time - Gaza</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Europe/Helsinki'){ echo "selected"; } ?> value="Europe/Helsinki" data-posinset="155">(GMT+03:00) Eastern European Time - Helsinki</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Europe/Kiev'){ echo "selected"; } ?> value="Europe/Kiev" data-posinset="156">(GMT+03:00) Eastern European Time - Kiev</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Nicosia'){ echo "selected"; } ?> value="Asia/Nicosia" data-posinset="157">(GMT+03:00) Eastern European Time - Nicosia</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Europe/Riga'){ echo "selected"; } ?> value="Europe/Riga" data-posinset="158">(GMT+03:00) Eastern European Time - Riga</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Europe/Sofia'){ echo "selected"; } ?> value="Europe/Sofia" data-posinset="159">(GMT+03:00) Eastern European Time - Sofia</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Europe/Tallinn'){ echo "selected"; } ?> value="Europe/Tallinn" data-posinset="160">(GMT+03:00) Eastern European Time - Tallinn</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Europe/Vilnius'){ echo "selected"; } ?> value="Europe/Vilnius" data-posinset="161">(GMT+03:00) Eastern European Time - Vilnius</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Jerusalem'){ echo "selected"; } ?> value="Asia/Jerusalem" data-posinset="162">(GMT+03:00) Israel Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Europe/Minsk'){ echo "selected"; } ?> value="Europe/Minsk" data-posinset="163">(GMT+03:00) Moscow Standard Time - Minsk</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Europe/Moscow'){ echo "selected"; } ?> value="Europe/Moscow" data-posinset="164">(GMT+03:00) Moscow Standard Time - Moscow</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Antarctica/Syowa'){ echo "selected"; } ?> value="Antarctica/Syowa" data-posinset="165">(GMT+03:00) Syowa Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Europe/Istanbul'){ echo "selected"; } ?> value="Europe/Istanbul" data-posinset="166">(GMT+03:00) Turkey Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Yerevan'){ echo "selected"; } ?> value="Asia/Yerevan" data-posinset="167">(GMT+04:00) Armenia Standard Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Baku'){ echo "selected"; } ?> value="Asia/Baku" data-posinset="168">(GMT+04:00) Azerbaijan Standard Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Tbilisi'){ echo "selected"; } ?> value="Asia/Tbilisi" data-posinset="169">(GMT+04:00) Georgia Standard Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Dubai'){ echo "selected"; } ?> value="Asia/Dubai" data-posinset="170">(GMT+04:00) Gulf Standard Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Indian/Mauritius'){ echo "selected"; } ?> value="Indian/Mauritius" data-posinset="171">(GMT+04:00) Mauritius Standard Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Indian/Reunion'){ echo "selected"; } ?> value="Indian/Reunion" data-posinset="172">(GMT+04:00) Réunion Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Europe/Samara'){ echo "selected"; } ?> value="Europe/Samara" data-posinset="173">(GMT+04:00) Samara Standard Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Indian/Mahe'){ echo "selected"; } ?> value="Indian/Mahe" data-posinset="174">(GMT+04:00) Seychelles Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Kabul'){ echo "selected"; } ?> value="Asia/Kabul" data-posinset="175">(GMT+04:30) Afghanistan Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Tehran'){ echo "selected"; } ?> value="Asia/Tehran" data-posinset="176">(GMT+04:30) Iran Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Indian/Kerguelen'){ echo "selected"; } ?> value="Indian/Kerguelen" data-posinset="177">(GMT+05:00) French Southern &amp; Antarctic Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Indian/Maldives'){ echo "selected"; } ?> value="Indian/Maldives" data-posinset="178">(GMT+05:00) Maldives Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Antarctica/Mawson'){ echo "selected"; } ?> value="Antarctica/Mawson" data-posinset="179">(GMT+05:00) Mawson Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Karachi'){ echo "selected"; } ?> value="Asia/Karachi" data-posinset="180">(GMT+05:00) Pakistan Standard Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Dushanbe'){ echo "selected"; } ?> value="Asia/Dushanbe" data-posinset="181">(GMT+05:00) Tajikistan Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Ashgabat'){ echo "selected"; } ?> value="Asia/Ashgabat" data-posinset="182">(GMT+05:00) Turkmenistan Standard Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Tashkent'){ echo "selected"; } ?> value="Asia/Tashkent" data-posinset="183">(GMT+05:00) Uzbekistan Standard Time - Tashkent</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Aqtau'){ echo "selected"; } ?> value="Asia/Aqtau" data-posinset="184">(GMT+05:00) West Kazakhstan Time - Aqtau</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Aqtobe'){ echo "selected"; } ?> value="Asia/Aqtobe" data-posinset="185">(GMT+05:00) West Kazakhstan Time - Aqtobe</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Yekaterinburg'){ echo "selected"; } ?> value="Asia/Yekaterinburg" data-posinset="186">(GMT+05:00) Yekaterinburg Standard Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Colombo'){ echo "selected"; } ?> value="Asia/Colombo" data-posinset="187">(GMT+05:30) India Standard Time - Colombo</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Calcutta'){ echo "selected"; } ?> value="Asia/Calcutta" data-posinset="188">(GMT+05:30) India Standard Time - Kolkata</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Katmandu'){ echo "selected"; } ?> value="Asia/Katmandu" data-posinset="189">(GMT+05:45) Nepal Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Dhaka'){ echo "selected"; } ?> value="Asia/Dhaka" data-posinset="190">(GMT+06:00) Bangladesh Standard Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Thimphu'){ echo "selected"; } ?> value="Asia/Thimphu" data-posinset="191">(GMT+06:00) Bhutan Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Almaty'){ echo "selected"; } ?> value="Asia/Almaty" data-posinset="192">(GMT+06:00) East Kazakhstan Time - Almaty</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Indian/Chagos'){ echo "selected"; } ?> value="Indian/Chagos" data-posinset="193">(GMT+06:00) Indian Ocean Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Bishkek'){ echo "selected"; } ?> value="Asia/Bishkek" data-posinset="194">(GMT+06:00) Kyrgyzstan Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Omsk'){ echo "selected"; } ?> value="Asia/Omsk" data-posinset="195">(GMT+06:00) Omsk Standard Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Antarctica/Vostok'){ echo "selected"; } ?> value="Antarctica/Vostok" data-posinset="196">(GMT+06:00) Vostok Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Indian/Cocos'){ echo "selected"; } ?> value="Indian/Cocos" data-posinset="197">(GMT+06:30) Cocos Islands Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Yangon'){ echo "selected"; } ?> value="Asia/Yangon" data-posinset="198">(GMT+06:30) Myanmar Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Indian/Christmas'){ echo "selected"; } ?> value="Indian/Christmas" data-posinset="199">(GMT+07:00) Christmas Island Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Antarctica/Davis'){ echo "selected"; } ?> value="Antarctica/Davis" data-posinset="200">(GMT+07:00) Davis Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Hovd'){ echo "selected"; } ?> value="Asia/Hovd" data-posinset="201">(GMT+07:00) Hovd Standard Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Bangkok'){ echo "selected"; } ?> value="Asia/Bangkok" data-posinset="202">(GMT+07:00) Indochina Time - Bangkok</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Saigon'){ echo "selected"; } ?> value="Asia/Saigon" data-posinset="203">(GMT+07:00) Indochina Time - Ho Chi Minh City</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Krasnoyarsk'){ echo "selected"; } ?> value="Asia/Krasnoyarsk" data-posinset="204">(GMT+07:00) Krasnoyarsk Standard Time - Krasnoyarsk</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Jakarta'){ echo "selected"; } ?> value="Asia/Jakarta" data-posinset="205">(GMT+07:00) Western Indonesia Time - Jakarta</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Antarctica/Casey'){ echo "selected"; } ?> value="Antarctica/Casey" data-posinset="206">(GMT+08:00) Australian Western Standard Time - Casey</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Australia/Perth'){ echo "selected"; } ?> value="Australia/Perth" data-posinset="207">(GMT+08:00) Australian Western Standard Time - Perth</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Brunei'){ echo "selected"; } ?> value="Asia/Brunei" data-posinset="208">(GMT+08:00) Brunei Darussalam Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Makassar'){ echo "selected"; } ?> value="Asia/Makassar" data-posinset="209">(GMT+08:00) Central Indonesia Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Macau'){ echo "selected"; } ?> value="Asia/Macau" data-posinset="210">(GMT+08:00) China Standard Time - Macau</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Shanghai'){ echo "selected"; } ?> value="Asia/Shanghai" data-posinset="211">(GMT+08:00) China Standard Time - Shanghai</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Choibalsan'){ echo "selected"; } ?> value="Asia/Choibalsan" data-posinset="212">(GMT+08:00) Choibalsan Standard Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Hong_Kong'){ echo "selected"; } ?> value="Asia/Hong_Kong" data-posinset="213">(GMT+08:00) Hong Kong Standard Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Irkutsk'){ echo "selected"; } ?> value="Asia/Irkutsk" data-posinset="214">(GMT+08:00) Irkutsk Standard Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Kuala_Lumpur'){ echo "selected"; } ?> value="Asia/Kuala_Lumpur" data-posinset="215">(GMT+08:00) Malaysia Time - Kuala Lumpur</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Manila'){ echo "selected"; } ?> value="Asia/Manila" data-posinset="216">(GMT+08:00) Philippine Standard Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Singapore'){ echo "selected"; } ?> value="Asia/Singapore" data-posinset="217">(GMT+08:00) Singapore Standard Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Taipei'){ echo "selected"; } ?> value="Asia/Taipei" data-posinset="218">(GMT+08:00) Taipei Standard Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Ulaanbaatar'){ echo "selected"; } ?> value="Asia/Ulaanbaatar" data-posinset="219">(GMT+08:00) Ulaanbaatar Standard Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Dili'){ echo "selected"; } ?> value="Asia/Dili" data-posinset="220">(GMT+09:00) East Timor Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Jayapura'){ echo "selected"; } ?> value="Asia/Jayapura" data-posinset="221">(GMT+09:00) Eastern Indonesia Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Tokyo'){ echo "selected"; } ?> value="Asia/Tokyo" data-posinset="222">(GMT+09:00) Japan Standard Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Pyongyang'){ echo "selected"; } ?> value="Asia/Pyongyang" data-posinset="223">(GMT+09:00) Korean Standard Time - Pyongyang</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Seoul'){ echo "selected"; } ?> value="Asia/Seoul" data-posinset="224">(GMT+09:00) Korean Standard Time - Seoul</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Pacific/Palau'){ echo "selected"; } ?> value="Pacific/Palau" data-posinset="225">(GMT+09:00) Palau Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Yakutsk'){ echo "selected"; } ?> value="Asia/Yakutsk" data-posinset="226">(GMT+09:00) Yakutsk Standard Time - Yakutsk</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Australia/Darwin'){ echo "selected"; } ?> value="Australia/Darwin" data-posinset="227">(GMT+09:30) Australian Central Standard Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Australia/Adelaide'){ echo "selected"; } ?> value="Australia/Adelaide" data-posinset="228">(GMT+09:30) Central Australia Time - Adelaide</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Australia/Brisbane'){ echo "selected"; } ?> value="Australia/Brisbane" data-posinset="229">(GMT+10:00) Australian Eastern Standard Time - Brisbane</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Pacific/Guam'){ echo "selected"; } ?> value="Pacific/Guam" data-posinset="230">(GMT+10:00) Chamorro Standard Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Pacific/Chuuk'){ echo "selected"; } ?> value="Pacific/Chuuk" data-posinset="231">(GMT+10:00) Chuuk Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Antarctica/DumontDUrville'){ echo "selected"; } ?> value="Antarctica/DumontDUrville" data-posinset="232">(GMT+10:00) Dumont-d’Urville Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Australia/Hobart'){ echo "selected"; } ?> value="Australia/Hobart" data-posinset="233">(GMT+10:00) Eastern Australia Time - Hobart</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Australia/Melbourne'){ echo "selected"; } ?> value="Australia/Melbourne" data-posinset="234">(GMT+10:00) Eastern Australia Time - Melbourne</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Australia/Sydney'){ echo "selected"; } ?> value="Australia/Sydney" data-posinset="235">(GMT+10:00) Eastern Australia Time - Sydney</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Pacific/Port_Moresby'){ echo "selected"; } ?> value="Pacific/Port_Moresby" data-posinset="236">(GMT+10:00) Papua New Guinea Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Vladivostok'){ echo "selected"; } ?> value="Asia/Vladivostok" data-posinset="237">(GMT+10:00) Vladivostok Standard Time - Vladivostok</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Pacific/Kosrae'){ echo "selected"; } ?> value="Pacific/Kosrae" data-posinset="238">(GMT+11:00) Kosrae Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Magadan'){ echo "selected"; } ?> value="Asia/Magadan" data-posinset="239">(GMT+11:00) Magadan Standard Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Pacific/Noumea'){ echo "selected"; } ?> value="Pacific/Noumea" data-posinset="240">(GMT+11:00) New Caledonia Standard Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Pacific/Norfolk'){ echo "selected"; } ?> value="Pacific/Norfolk" data-posinset="241">(GMT+11:00) Norfolk Island Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Pacific/Pohnpei'){ echo "selected"; } ?> value="Pacific/Pohnpei" data-posinset="242">(GMT+11:00) Ponape Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Pacific/Guadalcanal'){ echo "selected"; } ?> value="Pacific/Guadalcanal" data-posinset="243">(GMT+11:00) Solomon Islands Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Pacific/Efate'){ echo "selected"; } ?> value="Pacific/Efate" data-posinset="244">(GMT+11:00) Vanuatu Standard Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Pacific/Fiji'){ echo "selected"; } ?> value="Pacific/Fiji" data-posinset="245">(GMT+12:00) Fiji Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Pacific/Tarawa'){ echo "selected"; } ?> value="Pacific/Tarawa" data-posinset="246">(GMT+12:00) Gilbert Islands Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Pacific/Kwajalein'){ echo "selected"; } ?> value="Pacific/Kwajalein" data-posinset="247">(GMT+12:00) Marshall Islands Time - Kwajalein</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Pacific/Majuro'){ echo "selected"; } ?> value="Pacific/Majuro" data-posinset="248">(GMT+12:00) Marshall Islands Time - Majuro</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Pacific/Nauru'){ echo "selected"; } ?> value="Pacific/Nauru" data-posinset="249">(GMT+12:00) Nauru Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Pacific/Auckland'){ echo "selected"; } ?> value="Pacific/Auckland" data-posinset="250">(GMT+12:00) New Zealand Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Asia/Kamchatka'){ echo "selected"; } ?> value="Asia/Kamchatka" data-posinset="251">(GMT+12:00) Petropavlovsk-Kamchatski Standard Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Pacific/Funafuti'){ echo "selected"; } ?> value="Pacific/Funafuti" data-posinset="252">(GMT+12:00) Tuvalu Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Pacific/Wake'){ echo "selected"; } ?> value="Pacific/Wake" data-posinset="253">(GMT+12:00) Wake Island Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Pacific/Wallis'){ echo "selected"; } ?> value="Pacific/Wallis" data-posinset="254">(GMT+12:00) Wallis &amp; Futuna Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Pacific/Apia'){ echo "selected"; } ?> value="Pacific/Apia" data-posinset="255">(GMT+13:00) Apia Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Pacific/Enderbury'){ echo "selected"; } ?> value="Pacific/Enderbury" data-posinset="256">(GMT+13:00) Phoenix Islands Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Pacific/Fakaofo'){ echo "selected"; } ?> value="Pacific/Fakaofo" data-posinset="257">(GMT+13:00) Tokelau Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Pacific/Tongatapu'){ echo "selected"; } ?> value="Pacific/Tongatapu" data-posinset="258">(GMT+13:00) Tonga Standard Time</option>
                        <option <?php if($setting->get_option('ct_timezone')=='Pacific/Kiritimati'){ echo "selected"; } ?> value="Pacific/Kiritimati" data-posinset="259">(GMT+14:00) Line Islands Time</option>
                      </select>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <input type="text" id="company_name" style="width: 300px;"class="form-control" size="35" name="ct_company_name" value="<?php echo $setting->get_option('ct_company_name');?>" placeholder="<?php echo $label_language_values['company_name'];?>" />
                    ...
                    <td><label><?php echo $label_language_values['company_email'];?></label></td>
                                    <td>
                                        <div class="form-group">
                                            <input type="email" style="width: 300px;" class="form-control" id="company_email" size="35" name="ct_company_email" value="<?php echo $setting->get_option('ct_company_email');?>" placeholder="<?php echo $label_language_values['company_email'];?>" />
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                ...
                <tr>
                        ...
                        <option  value="8640" <?php  if($setting->ct_min_advance_booking_time=='8640'){echo 'selected';} ?>>6 <?php  echo $label_language_values['days'];?></option>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="form-group">
                                      <select name="ct_service_design" id="ct_service_design" class="selectpicker" style="display: none;">
                                        <option value="ct_square" <?php  if($setting->ct_service_design=='ct_square'){echo 'selected';} ?>> <?php echo "Square"; ?></option>
                                        <option value="ct_circle" <?php  if($setting->ct_service_design=='ct_circle'){echo 'selected';} ?>><?php  echo "Circle"; ?></option>
                                      </select>
                                    </div>
                                  </td>
                                </tr>
                        ...
                        <input data-toggle="toggle" data-size="small" type='checkbox' name="ct_star_show_on_front" <?php  if($setting->ct_star_show_on_front=='Y'){echo 'checked';}?> id="star_show_on_front" data-on="<?php echo $label_language_values['enable'];?>" data-off="<?php echo $label_language_values['disable'];?>" data-onstyle='success' data-offstyle='danger' />
                      </label>
                                        </div>
                                        <a class="ct-tooltip-link" href="#" data-toggle="tooltip" title="<?php echo $label_language_values['with_enable_of_this_feature_shows_staff_rating_on_front_side'];?>."><i class="fa fa-info-circle fa-lg"></i></a>
                                    </td>
                                </tr>
                                <tr>
 ...
 <tr>
		...
		<td>
				<div class="form-group">
						<select name="ct_service_default_design" id="ct_booking_page_design" class="selectpicker" style="display: none;">
								<option value="S" <?php  if($setting->get_option("ct_booking_page_design")=='S'){echo 'selected';} ?>><?php echo $label_language_values['single_step_booking_design'];?></option>
								<option value="M" <?php  if($setting->get_option("ct_booking_page_design")=='M'){echo 'selected';} ?>><?php echo $label_language_values['multi_step_booking_design'];?></option>
						</select>
				</div>
		</td>
</tr>
        ...
        <form id="loginpageimage" method="post" enctype="multipart/form-data" class="ct-appearance-settings">
                ...
                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <label for="ct_show_time_duration">
                        <input data-toggle="toggle" name="ct_show_time_duration" data-size="small" type='checkbox' <?php  if($setting->ct_show_time_duration=='Y'){echo 'checked';}?> id="ct_show_time_duration" data-on="<?php echo $label_language_values['o_n'];?>"  data-off="<?php echo $label_language_values['off'];?>" data-onstyle='primary' data-offstyle='default' />
                      </label>
                                        </div>
                                    </td>
                                </tr>
  ...
  array("af","Afghanistan (&#8235;افغانستان&#8236;&lrm;)","+93"),array("al","Albania (Shqipëri)","+355  "),array("dz","Algeria (&#8235;الجزائر&#8236;&lrm;)","+213"),array("as","American Samoa","+1684 "),array("ad","Andorra","+376"),array("ao","Angola","+244"),array("ai","Anguilla","+1264"),array("ag","Antigua and Barbuda","+1268"),array("ar","Argentina","+54"),array("am","Armenia (Հայաստան)","+374"), array("aw","Aruba","+297"), array("au","Australia","+61"),array("at","Austria (Österreich)","+43"),array("az","Azerbaijan (Azərbaycan)","+994"),array("bs","Bahamas","+1242"),array("bh","Bahrain (&#8235;البحرين&#8236;&lrm;)","+973"),array("ct","Bangladesh (বাংলাদেশ)","+880"),array("bb","Barbados","+1246"), array("by","Belarus (Беларусь)","+375"),array("be","Belgium (België)","+32"),array("bz","Belize","+501"),array("bj","Benin (Bénin)","+229"),array("bm","Bermuda","+1441"),array("bt","Bhutan (འབྲུག)  ","+975"),array("bo","Bolivia","+591"),array("ba","Bosnia and Herzegovina (Босна и Херцеговина)","+387"),array("bw","Botswana","+267"),array("br","Brazil (Brasil)","+55"),array("io","British Indian Ocean Territory","+246"),array("vg","British Virgin Islands","+1284"),array("bn","Brunei","+673"),array("bg","Bulgaria (България)","+359"),array("bf","Burkina Faso","+226"),array("bi","Burundi (Uburundi)","+257"),array("kh","Cambodia (កម្ពុជា)","+855 "), array("cm","Cameroon (Cameroun)","+237"),array("ca","Canada","+1"),array("cv","Cape Verde (Kabu Verdi)","+238 "),array("bq","Caribbean Netherlands","+599 "), array("ky","Cayman Islands","+1345"), array("cf","Central African Republic (République centrafricaine)","+236"),array("td","Chad (Tchad)","+23"),array("cl","Chile","+56"),array("cn","China (中国)","+86"),array("cx","Christmas Island","+61"),array("cc","Cocos (Keeling) Islands","+61"),array("co","Colombia","+57"),array("km","Comoros (&#8235;جزر القمر&#8236;&lrm;)","+269"),array("cd","Congo (DRC) (Jamhuri ya Kidemokrasia ya Kongo)","+243"),array("cg","Congo (Republic) (Congo-Brazzaville)","+242"),array("ck","Cook Islands","+682"),array("cr","Costa Rica","+506"),array("ci","Côte d’Ivoire","+225"),array("hr","Croatia (Hrvatska)","+385"),array("cu","Cuba","+53"),array("cw","Curaçao","+599"),array("cy","Cyprus (Κύπρος)","+357"),array("cz","Czech Republic (Česká republika)","+420"),array("dk","Denmark (Danmark)","+45"),array("dj","Djibouti","+253"),array("dm","Dominica","+1767"),array("do","Dominican Republic (República Dominicana)","+1"),array("ec","Ecuador","+593"),array("eg","Egypt (&#8235;مصر&#8236;&lrm;)","+20 "),array("sv","El Salvador","+503"),array("gq","Equatorial Guinea (Guinea Ecuatorial)","+240"),array("er","Eritrea","+291"),array("ee","Estonia (Eesti)","+372"),array("et","Ethiopia","+251"),array("fk","Falkland Islands (Islas Malvinas)","+500"),array("fo","Faroe Islands (Føroyar)","+298"),array("fj","Fiji","+679"),array("fi","Finland (Suomi)","+358"),array("fr","France","+33"),array("gf","French Guiana (Guyane française)","+594"),array("pf","French Polynesia (Polynésie française)","+689"),array("ga","Gabon","+241"), array("gm","Gambia","+220"),array("ge","Georgia (საქართველო)","+995"),array("de","Germany (Deutschland)","+49"),array("gh","Ghana (Gaana)","+233"),array("gi","Gibraltar","+350"),array("gr","Greece (Ελλάδα)","+30"),array("gl","Greenland (Kalaallit Nunaat)","+299"),array("gd","Grenada","+1473"), array("gp","Guadeloupe","+590"),array("gu","Guam","+1671"),array("gt","Guatemala","+502"),array("gg","Guernsey","+44"),array("gn","Guinea (Guinée)","+224"),array("gw","Guinea-Bissau (Guiné Bissau)","+245"),array("gy","Guyana","+592"),array("ht","Haiti","+509"),array("hn","Honduras","+504"),array("hk","Hong Kong (香港)","+852"),array("hu","Hungary (Magyarország)","+36"),array("is","Iceland (Ísland)","+354"),array("in","India (भारत)","+91"),array("id","Indonesia","+62"),array("ir","Iran (&#8235;ایران&#8236;&lrm;)","+98"),array("iq","Iraq (&#8235;العراق&#8236;&lrm;)","+964"),array("ie","Ireland","+353"),array("im","Isle of Man","+44"),array("il","Israel (&#8235;ישראל&#8236;&lrm;)","+972"),array("it","Italy (Italia)","+39"),array("jm","Jamaica","+1876"),array("jp","Japan (日本)","+81"),array("je","Jersey","+44"),array("jo","Jordan (&#8235;الأردن&#8236;&lrm;)","+962"),array("kz","Kazakhstan (Казахстан)","+7"),array("ke","Kenya","+254"),array("ki","Kiribati","+686"),array("kw","Kuwait (&#8235;الكويت&#8236;&lrm;)","+965"),array("kg","Kyrgyzstan (Кыргызстан)","+996"),array("la","Laos (ລາວ)","+856"),array("lv","Latvia (Latvija)","+371"),array("lb","Lebanon (&#8235;لبنان&#8236;&lrm;)","+961"),array("ls","Lesotho","+266"),array("lr","Liberia","+231"),array("ly","Libya (&#8235;ليبيا&#8236;&lrm;)","+218"),array("li","Liechtenstein","+423"),array("lt","Lithuania (Lietuva)","+370"),array("lu","Luxembourg","+352"),array("mo","Macau (澳門)","+853"),array("mk","Macedonia (FYROM) (Македонија)","+389"),array("mg","Madagascar (Madagasikara)","+261"),array("mw","Malawi","+265"),array("my","Malaysia","+60"),array("mv","Maldives","+960"),array("ml","Mali","+223"), array("mt","Malta","+356"),array("mh","Marshall Islands","+692"),array("mq","Martinique","+596"),array("mr","Mauritania (&#8235;موريتانيا&#8236;&lrm;)","+222"),array("mu","Mauritius (Moris)","+230"),array("yt","Mayotte","+262"),array("mx","Mexico (México)","+52"),array("fm","Micronesia","+691"),array("md","Moldova (Republica Moldova)","+373"),array("mc","Monaco","+377"),array("mn","Mongolia (Монгол)","+976"),array("me","Montenegro (Crna Gora)","+382"),array("ms","Montserrat","+1664"),array("ma","Morocco (&#8235;المغرب&#8236;&lrm;)","+212"),array("mz","Mozambique (Moçambique)","+258"),array("mm","Myanmar (Burma) (မြန်မာ)","+95"),array("na","Namibia (Namibië)","+264"),array("nr","Nauru","+674"),array("np","Nepal (नेपाल)","+977"),array("nl","Netherlands (Nederland)","+31"),array("nc","New Caledonia (Nouvelle-Calédonie)","+687"),array("nz","New Zealand","+64"),array("ni","Nicaragua","+505"),array("ne","Niger (Nijar)","+227"),array("ng","Nigeria","+234"),array("nu","Niue","+683"),array("nf","Norfolk Island","+672"),array("kp","North Korea (조선 민주주의 인민 공화국)","+850"),array("mp","Northern Mariana Islands","+1670"),array("no","Norway (Norge)","+47"),array("om","Oman (&#8235;عُمان&#8236;&lrm;)","+968"),array("pk","Pakistan (&#8235;پاکستان&#8236;&lrm;)","+92"),array("pw","Palau","+680"),array("ps","Palestine (&#8235;فلسطين&#8236;&lrm;)","+970"),array("pa","Panama (Panamá)","+507"),array("pg","Papua New Guinea","+675"),array("py","Paraguay","+595"),array("pe","Peru (Perú)","+51"),array("ph","Philippines","+63"),array("pl","Poland (Polska)","+48"),array("pt","Portugal","+351"),array("pr","Puerto Rico","+1"),array("qa","Qatar (&#8235;قطر&#8236;&lrm;)","+974"),array("re","Réunion (La Réunion)","+262"),array("ro","Romania (România)","+40"),array("ru","Russia (Россия)","+7"),array("rw","Rwanda","+250"),array("bl","Saint Barthélemy (Saint-Barthélemy)","+590"),array("sh","Saint Helena","+290"), array("kn","Saint Kitts and Nevis","+1869"),array("lc","Saint Lucia","+1758"), array("mf","Saint Martin (Saint-Martin (partie française))","+590"),array("pm","Saint Pierre and Miquelon (Saint-Pierre-et-Miquelon)","+508"), array("vc","Saint Vincent and the Grenadines","+1784"),array("ws","Samoa","+685"),array("sm","San Marino","+378"),array("st","São Tomé and Príncipe (São Tomé e Príncipe)","+239"),array("sa","Saudi Arabia (&#8235;المملكة العربية السعودية&#8236;&lrm;)","+966"),array("sn","Senegal (Sénégal)","+221"),array("rs","Serbia (Србија)","+381"),array("sc","Seychelles","+248"),array("sl","Sierra Leone","+232"),array("sg","Singapore","+65"),array("sx","Sint Maarten","+1721"),array("sk","Slovakia (Slovensko)","+421"),array("si","Slovenia (Slovenija)","+386"),array("sb","Solomon Islands","+677"),array("so","Somalia (Soomaaliya)","+252"),array("za","South Africa","+27"),array("kr","South Korea (대한민국)","+82"),array("ss","South Sudan (&#8235;جنوب السودان&#8236;&lrm;)","+211"),array("es","Spain (España)","+34"),array("lk","Sri Lanka (ශ්&zwj;රී ලංකාව)","+94"),array("sd","Sudan (&#8235;السودان&#8236;&lrm;)","+249"),array("sr","Suriname","+597"),array("sj","Svalbard and Jan Mayen","+47"),array("sz","Swaziland","+268"),array("se","Sweden (Sverige)","+46"),array("ch","Switzerland (Schweiz)","+41"),array("sy","Syria (&#8235;سوريا&#8236;&lrm;)","+963"),array("tw","Taiwan (台灣)","+886"),array("tj","Tajikistan","+992"),array("tz","Tanzania","+255"),array("th","Thailand (ไทย)","+66"),array("tl","Timor-Leste","+670"),array("tg","Togo","+228"),array("tk","Tokelau","+690"),array("to","Tonga","+676"),array("tt","Trinidad and Tobago","+1868"),array("tn","Tunisia (&#8235;تونس&#8236;&lrm;)","+216"),array("tr","Turkey (Türkiye)","+90"),array("tm","Turkmenistan","+993"),array("tc","Turks and Caicos Islands","+1649"),array("tv","Tuvalu","+688"),array("vi","U.S. Virgin Islands","+1340"),array("ug","Uganda","+256"),array("ua","Ukraine (Україна)","+380"),array("ae","United Arab Emirates (&#8235;الإمارات العربية المتحدة&#8236;&lrm;)","+971"),array("gb","United Kingdom","+44"),array("us","United States","+1"),array("uy","Uruguay","+598"),array("uz","Uzbekistan (Oʻzbekiston)","+998"),array("vu","Vanuatu","+678"),array("va","Vatican City (Città del Vaticano)","+39"),array("ve","Venezuela","+58"),array("vn","Vietnam (Việt Nam)","+84"),array("wf","Wallis and Futuna","+681"),array("eh","Western Sahara (&#8235;الصحراء الغربية&#8236;&lrm;)","+212"),array("ye","Yemen (&#8235;اليمن&#8236;&lrm;)","+967"),array("zm","Zambia","+260"),array("zw","Zimbabwe","+263"),array("ax","Åland Islands","+358")); ?>
                ...
                <tr>
                  ...
                  <td>
                  <div class="ct-custom-radio">
                    <ul class="ct-radio-list app-set" style="margin-bottom: 0px;padding-left: 0px;">
                                  ...
                                  <input class='cta-toggle-checkbox payment_choice' data-toggle="toggle" data-size="small" type='checkbox' name="" <?php  if($setting->ct_paypal_express_checkout_status=='on'){echo 'checked';}?> id="paypal-checkout" data-on="<?php echo $label_language_values['enable'];?>" data-off="<?php echo $label_language_values['disable'];?>" data-onstyle='success' data-offstyle='danger' />
                                      ...
                                      <a class="ct-tooltip-link" href="#" data-toggle="tooltip" title="<?php echo $label_language_values['paypal_api_username_can_get_easily_from_developer_paypal_com_account'];?>"><i class="fa fa-info-circle fa-lg lgf"></i></a>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="form-group ct-lgf">
                                                                            <input type="text" class="form-control" id="ct_paypal_api_password" value="<?php echo ($setting->ct_paypal_api_password)?>" name="ct-paypal-api-password" size="50" />
                                                        ...
                                                        <div class="panel-body p-10">
                                                            <table class="form-inline ct-common-table">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control" id="ct_stripe_publishablekey" value="<?php echo ($setting->ct_stripe_publishablekey) ?>" name="ct-paypal-stripe- publishableKey" size="50" />
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                                </tbody>
                          ...
                          <div class="ct-email-temp-collapse-div col-md-12 col-lg-12 col-xs-12 np">
                            <form id="" method="post" type="" class="slide-toggle email_template_form" >
                              <div class="col-md-8 col-sm-8 col-xs-12">
                                ...
                                <a name="" data-id="<?php  echo $readall_admin['id']; ?>" class="btn btn-warning ct-btn-width cb ml-15 mt-20 preview_email_contents" data-title="<?php echo $label_language_values[strtolower(str_replace(" ","_",$readall_admin['email_subject']))]; ?>" type="submit"><?php echo $label_language_values['preview_template'];?></a>
                              </div>
                              <div class="col-md-4 col-sm-4 col-xs-12">
                                <div class="ct-email-content-tags">
                                  <b><?php echo $label_language_values['tags'];?></b><br>
                                ...
                                <table class="form-inline table ct-common-table table-hover table-bordered table-striped" >
                                    ...
                                    <th colspan="3"><?php echo $label_language_values['twilio_sms_settings'];?></th>
                                        ...
                                        <td colspan="2">
                                          <div class="form-group">
                                            <label class="ctoggle-ct-sms-reminder-client-status" for="ct-sms-reminder-client-status">
                                              <input data-toggle="toggle" data-size="small" type='checkbox' name="" <?php  if($setting->ct_sms_twilio_send_sms_to_client_status == "Y"){echo "checked";}else{echo "";}?> id="ct-sms-reminder-client-status" data-on="<?php echo $label_language_values['enable'];?>" data-off="<?php echo $label_language_values['disable'];?>" data-onstyle='success' data-offstyle='danger' />
                                            </label>
                                          </div>  
                                        ...
                                        <td colspan="2">
                                          <div class="form-group">
                                            <label class="ctoggle-ct-sms-reminder-admin-status" for="ct-sms-reminder-admin-status">
                                              <input data-toggle="toggle" data-size="small" type='checkbox' name="" <?php  if($setting->ct_sms_twilio_send_sms_to_admin_status == "Y"){echo "checked";}else{echo "";}?> id="ct-sms-reminder-admin-status" data-on="<?php echo $label_language_values['enable'];?>" data-off="<?php echo $label_language_values['disable'];?>" data-onstyle='success' data-offstyle='danger' />
                                            </label>
                                          </div>  
                                          <a class="ct-tooltip-link" href="#" data-toggle="tooltip" title="<?php echo $label_language_values['enable_or_disable_send_sms_to_client_for_appointment_booking_info'];?>"><i class="fa fa-info-circle fa-lg"></i></a>
                                        </td>
                                      ...
                                      <tr>
                                        ...
                                        <td colspan="2">
                                          <div class="form-group">
                                            <label class="ctoggle-ct-sms-reminder-staff-status" for="ct-sms-reminder-staff-status">
                                              <input data-toggle="toggle" data-size="small" type='checkbox' name="" <?php  if($setting->ct_sms_twilio_send_sms_to_staff_status == "Y"){echo "checked";}else{echo "";}?> id="ct-sms-reminder-staff-status" data-on="<?php echo $label_language_values['enable'];?>" data-off="<?php echo $label_language_values['disable'];?>" data-onstyle='success' data-offstyle='danger' />
                                            </label>
                                          </div>  
                                          <a class="ct-tooltip-link" href="#" data-toggle="tooltip" title="<?php echo $label_language_values['enable_or_disable_send_sms_to_staff_for_appointment_booking_info'];?>"><i class="fa fa-info-circle fa-lg"></i></a>
                                        </td>
                                      </tr>
                                      <tr>
                                  ...
                                  <table class="form-inline table ct-common-table table-hover table-bordered table-striped" >
                                    ...
                                    <th colspan="3"><?php echo $label_language_values['plivo_sms_settings'];?></th>
                                      ...
                                      <tr>
                                        ...
                                        <td colspan="2">
                                          <div class="form-group">
                                            <label class="ctoggle-ct-sms-reminder-staff-status-plivo" for="ct-sms-reminder-staff-status-plivo">
                                              <input data-toggle="toggle" data-size="small" type='checkbox' name="" <?php  if($setting->ct_sms_plivo_send_sms_to_staff_status == "Y"){echo "checked";}else{echo "";}?> id="ct-sms-reminder-staff-status-plivo" data-on="<?php echo $label_language_values['enable'];?>" data-off="<?php echo $label_language_values['disable'];?>" data-onstyle='success' data-offstyle='danger' />
                                            </label>
                                          </div>  
                                           <a class="ct-tooltip-link" href="#" data-toggle="tooltip" title="<?php echo $label_language_values['enable_or_disable_send_sms_to_staff_for_appointment_booking_info'];?>"><i class="fa fa-info-circle fa-lg"></i></a>
                                        </td>
                                  ...
                                  <table class="form-inline table ct-common-table table-hover table-bordered table-striped" >
                                    ...
                                    <tbody>
                                      ...
                                      <td><label><?php echo $label_language_values['send_sms_to_staff'];?></label></td>
                                        <td colspan="2">
                                          <div class="form-group">
                                            <label class="ctoggle-ct-sms-reminder-staff-status-plivo" for="ct_sms_nexmo_send_sms_to_staff_status">
                                            <input data-toggle="toggle" data-size="small" type='checkbox' name="" <?php  if($setting->ct_sms_nexmo_send_sms_to_staff_status == "Y"){echo "checked";}else{echo "";}?> id="ct_sms_nexmo_send_sms_to_staff_status" data-on="<?php echo $label_language_values['enable'];?>" data-off="<?php echo $label_language_values['disable'];?>" data-onstyle='success' data-offstyle='danger' />
                                            </label>
                                          </div>
                                        </td>                                       
                                      </tr>
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <td colspan="2">
                                          <div class="form-group">
                                            <label class="ctoggle-ct-sms-reminder-staff-status" for="ct-sms-reminder-staff-status">
                                              <input data-toggle="toggle" data-size="small" type='checkbox' name="" <?php  if($setting->get_option('ct_sms_textlocal_send_sms_to_staff_status') == "Y"){echo "checked";}else{echo "";}?> id="ct-textlocal-sms-reminder-staff-status" data-on="<?php echo $label_language_values['enable'];?>" data-off="<?php echo $label_language_values['disable'];?>" data-onstyle='success' data-offstyle='danger' />
                                            </label>
                                          </div>
                                          <a class="ct-tooltip-link" href="#" data-toggle="tooltip" title="<?php echo $label_language_values['enable_or_disable_send_sms_to_staff_for_appointment_booking_info'];?>"><i class="fa fa-info-circle fa-lg"></i></a>
                                        </td>
              ...
              <div id="staff-sms-template" class="tab-pane fade">
                ...
                <div id="accordion" class="panel-group">
                  <ul class="nav nav-tab nav-stacked">
                                            ...
                                            {
                                                ?>
                                                <li class="panel panel-default ct-staff-sms-temp-panel" >
                                                    <div class="panel-heading br-2">
                                                        <h4 class="panel-title">
                                                            <div class="cta-col11">
                                                                <div class="pull-left">
                                      ...
                                      <input class='save_staff_sms_template_status' data-toggle="toggle" data-size="small" type='checkbox' data-id="<?php echo $staff_template['id'];?>" type="checkbox" name="" <?php  if($staff_template['sms_template_status']=='E'){echo "checked";}else{echo "";}?> id="sms-staff<?php  echo $staff_template['id'];?>" data-on="<?php echo $label_language_values['o_n'];?>"  data-off="<?php echo $label_language_values['off'];?>" data-onstyle='primary' data-offstyle='default' />
                                                                ...
                                                                <span class="ct-template-name"><?php echo $staff_template['sms_subject']; ?></span>
                                                            </div>
                                                            <div class="pull-right cta-col1">
                                                                <div class="pull-right">
                                                                    <div class="ct-show-hide pull-right">
                                                                        <input type="checkbox" name="ct-show-hide" class="ct-show-hide-checkbox ct_show_hide_checkbox" id="as<?php  echo $staff_template['id'];?>" data-id="<?php echo $staff_template['id']; ?>">
                                                                        <label class="ct-show-hide-label" for="as<?php  echo $staff_template['id'];?>"></label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </h4>
                                    ...
                                    <a id="save_sms_template" name="" data-id="<?php echo $staff_template['id'];?>" class="btn btn-success ct-btn-width pull-left cb ml-15 mt-20" type="submit"><?php echo $label_language_values['save_template'];?></a>
                                    <a id="default_sms_contents" name="" data-id="<?php echo $staff_template['id'];?>" class="btn btn-primary ct-btn-width pull-left cb ml-15 mt-20" type="submit"><?php echo $label_language_values['default_template'];?></a>
                                                                    </div>
                                                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                                                        <div class="ct-sms-content-tags">
                                                                            <b><?php echo $label_language_values['tags'];?></b><br>
                                  ...
                                  <a href="javascript:void(0);" data-id="<?php echo $staff_template['id']; ?>" class="tags sms_short_tags" data-value="{{booking_time}}">{{<?php echo $label_language_values['booking_time'];?>}}</a><br />
                                                                    ...
                                                                    <a href="javascript:void(0);" data-id="<?php echo $staff_template['id']; ?>" class="tags sms_short_tags" data-value="{{contact_status}}">{{<?php echo $label_language_values['contact_status'];?>}}</a><br />
                                  ...
                                  <a href="javascript:void(0);" data-id="<?php echo $staff_template['id']; ?>" class="tags sms_short_tags" data-value="{{client_promocode}}">{{<?php //echo $label_language_values['client_promocode'];?>client_promocode}}</a><br />
                                                                    ...
                                                                    <a href="javascript:void(0);" data-id="<?php echo $staff_template['id']; ?>" class="tags sms_short_tags" data-value="{{reject_status}}">{{<?php echo $label_language_values['reject_status'];?>}}</a><br />
          ...
          <div class="panel-body pt-50 plr-10">
              ...
              <table class="form-inline ct-common-table">
                <tbody>
                  <tr>
                    ...
                    if($setting->get_option('ct_recurrence_booking_status') == "Y") {$plans_on_stripe_d = "initial";}
                    ?>
                    ...
                    <td class="plans_on_stripe_div">
                      <div class="form-group">
                        <label class="ctoggle-postal-code"  for="show_company_logo_header">
                          <input class='cta-toggle-checkbox' data-toggle="toggle" data-size="small" type='checkbox' name="" <?php  if($setting->get_option('ct_stripe_create_plan') == "Y") { echo "checked";} ?>  id="ct_stripe_create_plan" data-on="<?php echo $label_language_values['enable'];?>" data-off="<?php echo $label_language_values['disable'];?>" data-onstyle='success' data-offstyle='danger' />
                        </label>
                      </div>
                    </td>
                    <?php         
            ...
            <div class="col-sm-12 col-lg-12 col-xs-12 reccurence_div" style="display: <?php     echo $show_reccurence_div; ?>">
              <div class="tab-content ct-settings-frequently-discount-details">
                ...
                <button id="ct-add-reccurence" class="btn btn-success float-right mb-15"><i class="fa fa-plus"></i><?php echo $label_language_values['add_recurrence'];?></button>
                  <div id="accordion" class="panel-group">
                    <ul class="nav nav-tab nav-stacked" id="sortable-frequently-discount" >   <!-- frequently-discount-services -->
                      ...
                      while($getdata = @mysqli_fetch_array($getalldis)){
                        ...
                        <li class="panel panel-default ct-frequently-discount-panel" >
                          <div class="panel-heading">
                            <h4 class="panel-title">
                              <div class="cta-col8">
                                  <span class="ct-frequently-discount-panel-title-name"><?php echo $getdata['discount_typename'];?></span>
                              </div>
                                    ...
                                    <table class="form-horizontal" cellspacing="0">
                                      ...
                                      <tr>
                                        <td>
                                          ...
                                          <button id="ct-close-popover-delete-reccurence" class="btn btn-default btn-sm" href="javascript:void(0)"><?php echo $label_language_values['cancel'];?></button>
                                        </td>
                                      </tr>
                                      </tbody>
                                    </table>
                              ...
                              <div class="ct-frequently-discount-collapse-div col-sm-12 col-md-12 col-lg-12 col-xs-12">
                                <form id="freq_discount_form<?php  echo $getdata['id'];?>" method="post" type="" class="slide-toggle" >
                                  ...
                                  <table class="form-inline ct-common-table ct-create-frequently-discount-table">
                                    ...
                                    <td></td>
                                      <td>
                                        <a data-id="<?php echo $getdata['id'];?>" name="" id="" class="btn btn-success ct-btn-width btnupdaterecurrence" ><?php echo $label_language_values['update'];?></a>
                                      </td>
                                    </tr>
                                    </tbody>
                                  </table>
                                  <?php      }else{
                                    ...
                                    <td></td>
                                      <td>
                                        <a data-id="<?php echo $getdata['id'];?>" name="" id="" class="btn btn-success ct-btn-width btnupdaterecurrence_once" ><?php echo $label_language_values['update'];?></a>
                                      </td>
                                    </tr>
                                    </tbody>
                                    </table>
                      ...
                      ?>
                      <li class="panel panel-default ct-frequently-discount-panel add_rec_li" style="display: none;" >
                        <div class="panel-heading">
                          <h4 class="panel-title">
                            <div class="cta-col8">
                              <span class="ct-frequently-discount-panel-title-name"></span>
                            </div>
                            <div class="pull-right cta-col4">
                              <div class="cta-col4"></div>
                              <div class="pull-right">
                                <div class="ct-show-hide pull-right">
                                  <input type="checkbox" name="ct-show-hide" class="ct-show-hide-checkbox" id="spssadd" ><!--Added Serivce Id-->
                                  <label class="ct-show-hide-label" for="spssadd"></label>
                                </div>
                              </div>
                            </div>
                          </h4>
                              ...
                              <form id="freq_discount_formadd" method="post" type="" class="slide-toggle" >
                                <table class="form-inline ct-common-table ct-create-frequently-discount-table">
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <div class="form-group">
                                        <select name="" id="txtfreqtypeadd" class="selectpicker" style="display: none;">
                                  ...
                                  <td></td>
                                    <td>
                                      <a class="btn btn-success ct-btn-width btnaddreccurence" ><?php echo $label_language_values['save'];?></a>
                                    </td>
                                  </tr>
                                  </tbody>
                                </table>
      ...
      <!-----recurrence booking End---->
            <div class="tab-pane fade in" id="promocode">
              ...
              <li class="special_offer"><a data-toggle="tab" href="#special_offer"><?php echo $label_language_values['ct_special_offer'];?></a></li>
                        </ul>
                        <div class="tab-content">
        ...
        <div id="special_offer" class="tab-pane fade">
          <form id="special_offer_form">
            <div>
              <div class="col-xs-12">
                <label class="col-xs-5 col-md-2 mt-36"><?php echo $label_language_values['ct_special_offer'];?></label>
                  <?php 
                    $chkbx="";
                    $nnn="none";
                    $txtvl="";
                    if($setting->get_option("ct_special_offer") == "Y"){
                      $chkbx="checked";
                      $nnn="block";
                      $txtvl=$setting->get_option("ct_special_offer_text");
                    }
                  ?>
                <label class="ctoggle-tax-vat mt-30 col-xs-7 col-md-10 special_offer_check" for="special_offer_check">
                  <input class="cta-toggle-checkbox1" data-toggle="toggle" data-size="small" type='checkbox' name="special_offer_check" <?php  /* if($setting->ct_special_offer=='Y'){echo 'checked';} */ ?> id="special_offer_check" data-on="<?php echo $label_language_values['enable'];?>" data-off="<?php echo $label_language_values['disable'];?>" data-onstyle='success' data-offstyle='danger' <?php  echo $chkbx; ?>      />
                </label>
              </div>
              <div style="display:<?php echo $nnn; ?>;" class="form-inline ct-common-table promocode_text col-xs-12">
                <label class="col-xs-5 col-md-2 mt-36"><?php echo $label_language_values['ct_special_offer_text'];?></label>
                ...
                <div class="tab-content">
                  ...
                  <div id="referal">
                    <div class="form-group col-xs-12">
                      ...
                      <label class="ctoggle-tax-vat pl-30" for="tax-vat">
                        <input class="cta-toggle-checkbox" data-toggle="toggle" data-size="small" type='checkbox' <?php  if($setting->ct_referral_status=='Y'){echo 'checked';}?> id="refer" data-on="<?php echo $label_language_values['enable'];?>" data-off="<?php echo $label_language_values['disable'];?>" data-onstyle='success' data-offstyle='danger' />
                        </label>
                        <div class="hide-div mycollapse_refer" <?php  if($setting->ct_referral_status=='Y'){echo 'style="display:block;"';}?>>

                          <div class="ct-custom-radio col-xs-12">
                            <label class="form-label">Refferal code value</label>
                            <ul class="ct-radio-list">
                              <li class="ct-refer-input-container">
                                <input type="text" class="form-control" name="ct_referral_value" id="ct_referral_value" value="<?php echo ($setting->ct_referral_value); ?>" size="3" maxlength="5" />
                                <i class="ct-tax-percent <?php  if($setting->ct_referral_type=='P'){echo 'fa fa-percent';}?>"></i>
                              </li>
                            </ul>
                          </div>
                          ...
                          <div class="ct-custom-radio col-xs-12">
                            ...
                            <ul class="ct-radio-list">
                              <li class="ct-refer-input-container">
                                <input type="text" class="form-control" name="ct_refs_value" id="ct_refs_value" value="<?php echo ($setting->ct_refs_value); ?>" size="3" maxlength="5" />
                              </li>
                            </ul>
                          </div>
                        </div>
                  ...
                  <div class="panel-body pt-50 plr-10">
                    <table class="form-inline ct-common-table" >
                      <tbody>
                        <tr>
                            <td>
                              <label><?php echo $label_language_values['select_language_to_change_label'];?></label>
                            </td>
                            <td>
                              <div class="form-group">
      ...
      <div class="tab-pane fade in" id="manageable-form-fields">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td></td>
										 ...
										 <tr>
                      <td><label><?php echo $label_language_values['wallet_section'];?></label></td>
                      <td>
                        <div class="form-group">
                          <label class="ctoggle-ct_subheaders" for="ct_wallet_section">
                            <input data-toggle="toggle" data-size="small" name="wallet_section" type='checkbox' <?php  if($setting->ct_wallet_section=='on'){echo 'checked';}?> id="ct_wallet_section" data-on="<?php echo $label_language_values['enable'];?>"  data-off="<?php echo $label_language_values['disable'];?>" data-onstyle='success' data-offstyle='danger' />
                          </label>
                        </div>
                        <?php  /*
          ...
          <tr>
           ...
           <td><?php echo $label_language_values['required'];?></td>
                      <td>
                      <?php $password_check = explode(",",$setting->get_option('ct_bf_password')); ?>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="form-group nm">
                          <label  class="ctoggle-postal-code" for="show-referral-input-oc">
                            
                            <input class='cta-toggle-checkbox' data-toggle="toggle" data-size="small" name="" type='checkbox' <?php  if($setting->ct_show_referral_input_on_checkout=='on'){echo 'checked';}?> id="show-referral-input-oc" data-on="<?php echo $label_language_values['enable'];?>"  data-off="<?php echo $label_language_values['disable'];?>" data-onstyle='success' data-offstyle='danger' />
                          </label>
                        </div>
                      </td>
                      <td></td>
